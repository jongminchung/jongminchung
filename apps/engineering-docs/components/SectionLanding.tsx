...
export function SectionLandingPage({ page }: { readonly page: SectionPage }): React.JSX.Element {
  ...
  return (
    <div className={styles.page} lang={page.locale}>
      ...
      {remaining.length === 0 ? null : (
        <section aria-labelledby="all-documents" className={styles.allDocuments}>
