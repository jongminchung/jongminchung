        ...
        <g key={label}>
          ...
          {i < 3 && (
            <g stroke="#868e96" strokeWidth={1.2} fill="#868e96">
              ...
              <path d={`M100 ${y + 34} l-3.5 -5 h7 z`} stroke="none" />
            </g>
          )}
        </g>
      );
...
const AgentSVG = () => {
  ...
  return (
    ...
    >
      ...
      <circle cx={cx} cy={cy} r={24} fill="#fff5f5" stroke="#fa5252" strokeWidth={1.4} />
      <text
        x={cx}
        y={cy + 4}
        textAnchor="middle"
...
export const AgentLoopDiagram = ({ caption }: { caption?: string }) => (
  <div className="bca-loop-card" style={{ fontFamily: FONT }}>
    ...
    <div className="bca-loop-grid">
      <div>
        <div className="bca-loop-panel-title" style={{ color: "#868e96" }}>
          워크플로
        </div>
        <WorkflowSVG />
      ...
      <div>
        <div className="bca-loop-panel-title" style={{ color: "#228be6" }}>
          에이전트
        </div>
        <AgentSVG />
        <div className="bca-loop-panel-desc">
