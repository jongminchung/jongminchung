...
const STRINGS = {
  ko: {
    caption: "핀 바운스 — 각 구간을 독립적으로 설계한 뒤 이어 붙인다",
  },
  en: {
    caption: "Pin bounce — each segment is designed independently, then stitched together",
  },
} as const;
...
export const BounceGraphDemo = ({ locale: lang = "ko" }: { locale?: Lang }) => {
