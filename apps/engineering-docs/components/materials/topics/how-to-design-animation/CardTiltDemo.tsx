...
const STRINGS = {
    ko: {
        name: "홍길동",
        bio: "애니메이션과 인터랙션에 관심이 많은 개발자입니다.",
        caption: "카드 위에서 마우스를 움직여보세요",
    },
    en: {
        name: "Jane Doe",
        bio: "A developer who loves animation and interaction.",
        caption: "Move your mouse over the card",
    },
} as const;

export const CardTiltDemo = ({ locale: lang = "ko" }: { locale?: Lang }) => {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <span>
                            <strong style={{ color: "#212529" }}>128</strong>{" "}
                            posts
                        </span>
                        <span>
                            <strong style={{ color: "#212529" }}>1.2k</strong>{" "}
                            followers
                        </span>
                    </div>
                </div>
