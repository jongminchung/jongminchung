...
const STRINGS = {
  ko: {
    label: "파일 업로드",
    caption: "실제 진행률이 뚝뚝 끊겨도 바는 부드럽게 목표를 쫓아간다",
  },
  en: {
    label: "File upload",
    caption: "Even when the real progress jumps in chunks, the bar smoothly chases the target",
  },
} as const;

export const ProgressBarDemo = ({ locale: lang = "ko" }: { locale?: Lang }) => {
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
          <span style={{ fontSize: 13, color: "#495057", fontWeight: 500 }}>{t.label}</span>
          <span
            ref={labelRef}
            style={{
              fontSize: 13,
