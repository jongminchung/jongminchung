...
function createControlled(cx: number, cy: number): Particle[] {
    const baseHue =
        20 +
        seededMaterialRandom("how-to-design-animation/RandomComparisonDemo") *
            30;
        ...
        >
            <div style={{ display: "flex", gap: 12 }}>
                <div style={{ flex: 1 }}>
                    ...
                    >
                        {t.speed}{" "}
                        <span style={{ color: "#868e96" }}>0 ~ 5</span>
                        <br />
                        {t.size} <span style={{ color: "#868e96" }}>1 ~ 9</span>
                        <br />
                        {t.color}{" "}
                        <span style={{ color: "#868e96" }}>0° ~ 360°</span>
                        <br />
                        {t.distribution}{" "}
                        <span style={{ color: "#868e96" }}>{t.randomDist}</span>
                    </div>
                </div>
                <div style={{ flex: 1 }}>
                    <SvgCanvas
                    ...
                    >
                        {t.speed}{" "}
                        <span style={{ color: "#868e96" }}>2 ~ 3.5</span>
                        <br />
                        {t.size}{" "}
                        <span style={{ color: "#868e96" }}>2.5 ~ 4</span>
                        <br />
                        {t.color}{" "}
