...
const STRINGS = {
  ko: {
    caption: "지수적 접근 — factor가 클수록 빠르게 목표에 수렴한다",
  },
  en: {
    caption: "Exponential approach — the larger the factor, the faster it converges on the target",
  },
} as const;

export const ExpApproachGraphDemo = ({ locale: lang = "ko" }: { locale?: Lang } = {}) => {
