...
const STRINGS = {
  ko: {
    scrollDown: "↓ 스크롤",
    cardTitle: "새로운 알림",
    cardBody: "스크롤 위치가 곧 애니메이션의 진행도가 된다. 올리면 자연스럽게 되돌아간다.",
    scrollUp: "↑ 다시 올려보세요",
    caption: "스크롤 위치가 곧 진행도 — 올리면 자연스럽게 되돌아간다",
  },
  en: {
    scrollDown: "↓ Scroll",
    ...
    scrollUp: "↑ Try scrolling back up",
    caption: "Scroll position is the progress — scroll up and it naturally reverses",
  },
} as const;

export const BidirectionalDemo = ({ locale: lang = "ko" }: { locale?: Lang }) => {
      ...
      >
        ...
        <div style={{ height: 800, position: "relative", zIndex: 2 }}>
          ...
          >
            ...
            <div style={{ fontSize: 12, color: "#868e96", lineHeight: 1.5 }}>{t.cardBody}</div>
          </div>
