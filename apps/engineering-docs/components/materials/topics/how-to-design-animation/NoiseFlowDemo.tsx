...
export const NoiseFlowDemo = () => {
  ...
  useEffect(() => {
    ...
    const particles: Particle[] = Array.from({ length: COUNT }, () => {
      const x = seededMaterialRandom("how-to-design-animation/NoiseFlowDemo") * W;
      const y = seededMaterialRandom("how-to-design-animation/NoiseFlowDemo") * H;
    ...
    const animate = () => {
      ...
      for (const p of particles) {
        ...
        // 노이즈에서 각도를 얻음
        const angle = noise2d(p.x * SCALE + time, p.y * SCALE) * Math.PI * 4;
