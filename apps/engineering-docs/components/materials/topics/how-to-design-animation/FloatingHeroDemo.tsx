...
const STRINGS = {
  ko: { caption: "각 요소마다 다른 진폭·주파수·위상을 가진다" },
  en: { caption: "Each element has a different amplitude, frequency, and phase" },
} as const;

export const FloatingHeroDemo = ({ locale: lang = "ko" }: { locale?: Lang }) => {
