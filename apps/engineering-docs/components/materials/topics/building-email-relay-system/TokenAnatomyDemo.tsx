...
function scenarioAt(index: number): ScenarioDef {
    ...
    if (scenario === undefined)
        throw new Error(`Missing token scenario ${index}.`);
    return scenario;
}
    ...
    return (
        ...
        >
            ...
            <div className="tad-legend">
                <span style={{ "--c": "#228be6" } as React.CSSProperties}>
                    티켓
                </span>
                <span style={{ "--c": "#40c057" } as React.CSSProperties}>
                    사용자
                </span>
                <span style={{ "--c": "#f59f00" } as React.CSSProperties}>
                    만료
                </span>
                <span style={{ "--c": "#7048e8" } as React.CSSProperties}>
                    서명
                </span>
            </div>
            ...
            <div className="tad-panel">
                <div className="tad-row" data-shown={rows >= 1}>
                    ...
                    <span
                        className="tad-mono"
                        style={{ color: "#adb5bd", fontSize: 11 }}
                    >
                        = HMAC(&quot;{payload}&quot;, SECRET)
                    </span>
                </div>
