  ...
  return (
    ...
    >
      ...
      >
        ...
        <strong style={{ color: "#228be6" }}>어텐션(attention)</strong>을 주는지 확인할 수 있습니다.
        Causal Mask(인과적 마스킹)로 인해 자기 자신과 이전 토큰에만 어텐션을 줄 수 있습니다.
      </div>
      ...
      >
        {TOKENS.map((token, i) => {
          ...
          const isAttended = weights !== null && selectedToken !== null && i <= selectedToken;
          const weight = isAttended && weights[i] !== undefined ? weights[i] : 0;
          const isMasked = selectedToken !== null && i > selectedToken;
                ...
                background: isSelected
                  ...
                  : isAttended
                    ...
                    : isMasked
                      ? "#f1f3f5"
                      : "#f8f9fa",
                color: isMasked ? "#ced4da" : isSelected ? "#228be6" : "#495057",
                userSelect: "none",
      ...
      {selectedToken !== null && weights && (
        ...
        >
          ...
          >
            <strong style={{ color: "#228be6" }}>{TOKENS[selectedToken]}</strong>의 어텐션 분포
          </div>
                ...
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <span
                    style={{
                      ...
                      fontSize: 14,
                      fontWeight: 500,
                      color: isAccessible ? "#495057" : "#ced4da",
                      flexShrink: 0,
                    }}
                  >
                    {token}
                  ...
                  <span
                    style={{
                      fontSize: 12,
                      color: isAccessible ? "#868e96" : "#ced4da",
                      width: 42,
                      textAlign: "right",
                      flexShrink: 0,
                  ...
                  >
                    {isAccessible ? `${(weight * 100).toFixed(0)}%` : "—"}
                  </span>
                </div>
              );
            })}
