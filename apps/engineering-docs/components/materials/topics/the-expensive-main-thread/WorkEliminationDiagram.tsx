...
export const WorkEliminationDiagram = ({
    caption,
    locale: lang = "ko",
}: Props) => {
        ...
        const animate = (time: number) => {
            ...
            lanes.forEach((lane, li) => {
                ...
                if (li === 0) {
                    ...
                    const queueX = (idx: number) =>
                        procLeft - 14 * s - idx * (size + 5 * s);
                    ...
                    spawnT.forEach((st, i) => {
                        ...
                        if (consumeAt[i]! > 0 && t >= consumeAt[i]!) {
                            ...
                            x =
                                queueX(slot[i]!) +
                                (procLeft + procW / 2 - queueX(slot[i]!)) *
                                    ease(cp);
                            alpha = 1 - cp;
                            if (cp < 1) procPulse = 1;
