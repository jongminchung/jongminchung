...
function makeRow([u, t, c]: [string, string, string]): HTMLDivElement {
    ...
    row.style.cssText =
        "padding:2px 0;font-size:12px;line-height:1.5;color:#495057;";
...
export const ChunkingCompareDemo = ({
    locale: lang = "ko",
}: {
    locale?: Lang;
}) => {
    ...
    const onTick = () => {
        ...
        for (let i = 0; i < BURST; i++)
            lines.push(randomLine(t.users, t.texts));
