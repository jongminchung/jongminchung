...
const STRINGS = {
    ...
    en: {
        caption:
            "Seam carving — shrink the photo's width by 30% while keeping the important subjects",
    ...
    useEffect(() => {
        ...
        if (!loadStartedRef.current) {
            ...
            img.onload = () => {
                ...
                originalRef.current = ctx
                    .getImageData(0, 0, IMG_W, IMG_H)
                    .data.slice();
    ...
    const run = () => {
        ...
        if (mode === "main") {
            ...
            const worker = new Worker(
                new URL("./seamCarver.worker.ts", import.meta.url),
                {
                    type: "module",
                },
            );
