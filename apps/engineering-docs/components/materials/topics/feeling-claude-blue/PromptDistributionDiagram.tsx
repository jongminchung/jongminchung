...
function drawHorizontal(ctx: SvgDrawingContext, w: number, s: number): number {
...
function drawVertical(ctx: SvgDrawingContext, w: number, s: number): number {
