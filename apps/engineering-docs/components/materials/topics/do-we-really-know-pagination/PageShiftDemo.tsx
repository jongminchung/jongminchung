...
export const PageShiftDemo = () => {
    ...
    useEffect(() => {
        ...
        const render = (now: number) => {
            ...
            const rowY = (visualIndex: number) =>
                listTop + visualIndex * (itemH + itemGap);
            ...
            page1.forEach((id, k) => {
                ...
                drawItem(ctx, offsetX, rowY(k), colW, itemH, `글 ${id}`, {
                    alpha: a,
                    fs,
                });
                drawItem(ctx, cursorX, rowY(k), colW, itemH, `글 ${id}`, {
                    alpha: a,
                    fs,
                });
            });
