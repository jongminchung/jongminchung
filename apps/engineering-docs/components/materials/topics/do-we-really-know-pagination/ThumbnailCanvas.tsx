...
function draw(ctx: SvgDrawingContext) {
  ...
  rr(ctx, rowX - 14, winY, rowW + 28, winH, 18, "rgba(34,139,230,0.09)", "#228be6", 5);
  for (let i = 2; i <= 4; i++) {
    const y = rowY(i);
  ...
  const barY = 812,
    pillH = 92,
    pillR = 22;
  const pills: Array<{ w: number; label: string; fill: string; color: string; stroke?: string }> = [
    ...
    { w: 92, label: "⋯", fill: "#ffffff", color: "#8b93a1" },
    { w: 260, label: "259,715", fill: "#fff0f0", color: "#e8590c", stroke: "#fa5252" },
    { w: 92, label: "›", fill: "#ffffff", color: "#8b93a1" },
  ];
