...
const TOTAL_CYCLE =
    PHASE_DURATIONS.reduce((a, b) => a + b, 0) + 4 * TRANSITION_DURATION;
...
export const BoundaryEvolutionDiagram = ({ caption }: Props) => {
    ...
    useEffect(() => {
        ...
        const animate = (time: number) => {
            ...
            for (let i = 0; i < 4; i++) {
                ...
                if (elapsed < acc + segLen) {
                    ...
                    if (segElapsed < PHASE_DURATIONS[i]!) {
                        ...
                        phase = i;
                        transProgress = smoothstep(
                            (segElapsed - PHASE_DURATIONS[i]!) /
                                TRANSITION_DURATION,
                        );
                    }
                    break;
            ...
            const currentBoxCount =
                transProgress > 0.5 ? toBoxes.length : fromBoxes.length;
