    ...
    useEffect(() => {
        ...
        const animate = (time: number) => {
            ...
            for (const p of particles) {
                const px =
                    cx + p.x * w + Math.sin(t * p.speed + p.phase) * 8 * s;
                const py =
                    p.y * h + Math.cos(t * p.speed * 0.7 + p.phase) * 6 * s;
            ...
            glowGrad.addColorStop(
                0.35,
                `rgba(200, 180, 255, ${0.03 * glowIntensity})`,
            );
            glowGrad.addColorStop(
                0.5,
                `rgba(255, 255, 255, ${0.08 * glowIntensity})`,
            );
            glowGrad.addColorStop(
                0.65,
                `rgba(200, 180, 255, ${0.03 * glowIntensity})`,
        ...
        const raf = scheduleMaterialFrame(animate);
