  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const render = () => {
        ...
        // 프레임 그리기
        const buf = nes.frame();
        const img = new ImageData(new Uint8ClampedArray(buf), SCREEN, SCREEN);
    ...
    >
      ...
      >
        <button
          ...
          style={{
            ...btn,
            ...(gameOver ? { background: "#228be6", color: "#fff", borderColor: "#228be6" } : null),
          }}
        ...
        <span
          ...
          style={{ fontSize: 12, color: "#495057", marginLeft: "auto", fontWeight: 600 }}
        >
          뱀 길이 {snakeLen}
        </span>
      </div>
      ...
      <div ref={containerRef} style={{ display: "flex", justifyContent: "center" }}>
        <div style={{ position: "relative", width: "100%", maxWidth: MAX_CANVAS }}>
          <canvas
            ref={canvasRef}
      ...
      <p style={{ fontSize: 12, color: "#868e96", textAlign: "center", margin: "10px 0 12px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        ...
        >
          <span />
          <button style={dpadBtn} aria-label="위" onClick={() => sendKey(KEY_UP)}>
            ▲
          </button>
          <span />
          <button style={dpadBtn} aria-label="왼쪽" onClick={() => sendKey(KEY_LEFT)}>
            ◀
          </button>
          <button style={dpadBtn} aria-label="아래" onClick={() => sendKey(KEY_DOWN)}>
            ▼
          </button>
          <button style={dpadBtn} aria-label="오른쪽" onClick={() => sendKey(KEY_RIGHT)}>
            ▶
          </button>
        </div>
      </div>
