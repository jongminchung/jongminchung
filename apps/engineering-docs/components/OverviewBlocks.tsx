...
const copy = {
    ko: {
        ...
        steps: [
            ...
            [
                "2",
                "공개 계약을 찾습니다",
                "설치, 사용법, 실제 export를 한 페이지에서 확인합니다.",
            ],
            [
                "3",
                "기반까지 추적합니다",
        ...
        ctaBody:
            "언어 쌍, 링크, 순서, 검색 데이터와 package export를 빌드마다 함께 검사합니다.",
    ...
    en: {
        ...
        steps: [
            ...
            [
                "2",
                "Find the public contract",
                "See installation, usage, and real exports on one page.",
            ],
            [
                "3",
