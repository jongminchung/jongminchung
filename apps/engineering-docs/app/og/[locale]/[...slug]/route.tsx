...
function resolvePage(locale: string, slug: readonly string[]): OgPageData | null {
...
export async function GET(_request: Request, context: RouteContext): Promise<Response> {
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ position: "relative", display: "flex", flexDirection: "column", width: 930 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
          ...
          <span style={{ color: "#716d7c", fontSize: 15 }}>{page.detail}</span>
          <span style={{ color: "#aaa6b3", fontSize: 15 }}>·</span>
          <span style={{ color: "#716d7c", fontSize: 15 }}>{page.updatedAt}</span>
        </div>
        <span
          style={{
            fontSize: titleSize,
