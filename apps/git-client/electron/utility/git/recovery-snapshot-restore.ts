...
export function sameSnapshotFile(left: SnapshotFile, right: SnapshotFile): boolean {
  return (
...
export async function safeUnlink(root: PinnedDirectory, expected: SnapshotFile): Promise<void> {
...
export async function captureIndexWithExistingLock(git: PinnedDirectory): Promise<SnapshotIndex> {
...
export function sameSnapshotIndex(left: SnapshotIndex, right: SnapshotIndex): boolean {
...
export async function commitIndexLock(lock: IndexLock, target: SnapshotIndex): Promise<void> {
