...
import { assertPinnedDirectory, pinDirectory, syncDirectory } from "./changelist-storage";
...
export async function pinRepository(repository: RepositoryRecord): Promise<PinnedDirectory> {
...
export function selectedPath(path: string, selected: ReadonlySet<string>): boolean {
