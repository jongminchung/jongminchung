...
function copyStoredEntry(entry: StoredRecoveryEntry): StoredRecoveryEntry {
    return {
        ...
        snapshot:
            entry.snapshot === null
                ? null
                : copyRepositorySnapshot(entry.snapshot),
    };
}
            ...
            try {
                ...
                try {
                    ...
                    if (refsApplied) {
                        ...
                        const rollbackTransaction = updateTransaction(
                            currentRefs,
                            rollbackCurrent,
                        );
