...
export function sameDirectory(metadata: Stats, directory: PinnedDirectory): boolean {
...
export async function repositoryDirectories(repository: RepositoryRecord): Promise<{
...
export function outcomeText(outcome: GitProcessOutcome, stream: "stdout" | "stderr"): string {
...
export async function assertParents(parents: readonly PinnedDirectory[]): Promise<void> {
...
export async function captureIndex(git: PinnedDirectory): Promise<CapturedIndex> {
