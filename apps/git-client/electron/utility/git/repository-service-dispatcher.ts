...
export async function dispatchRepositoryService(
  ...
  switch (request.operation) {
    ...
    case "preCommitCheck":
      return {
        operation: request.operation,
        value: await dependencies.inspection.preCommitCheck(request.repositoryId),
      };
    case "listGitConfig":
      return {
        operation: request.operation,
        value: await dependencies.inspection.listGitConfig(request.repositoryId),
      };
    case "listSubmodules":
      return {
        operation: request.operation,
        value: GitSubmoduleInfosSchema.parse(
          await dependencies.inspection.listSubmodules(request.repositoryId),
        ),
      };
    case "listMergedBranches":
      return {
    ...
    case "listRemotes":
      return {
        operation: request.operation,
        value: await dependencies.inspection.listRemotes(request.repositoryId),
      };
    case "listWorktrees":
      return {
        operation: request.operation,
        value: await dependencies.inspection.listWorktrees(request.repositoryId),
      };
    case "readIgnoreRules":
      return {
        operation: request.operation,
        value: await dependencies.ignoreRules.read(request.repositoryId),
      };
    case "writeIgnoreRules":
      await dependencies.ignoreRules.write(request.repositoryId, request.rules);
    ...
    case "importPatch":
      await dependencies.patches.importPatch(request.repositoryId, request.path, signal);
      return { operation: request.operation };
    case "createShelf":
      return {
        operation: request.operation,
    ...
    case "listShelves":
      return {
        operation: request.operation,
        value: await stored(dependencies.shelves).list(request.repositoryId),
      };
    case "applyShelf":
      ...
      return { operation: request.operation };
    case "deleteShelf":
      await stored(dependencies.shelves).delete(request.repositoryId, request.shelfId);
      return { operation: request.operation };
    case "listChangelists":
      return {
        operation: request.operation,
        value: await stored(dependencies.changelists).list(request.repositoryId, signal),
      };
    case "saveChangelist":
      return {
        operation: request.operation,
    ...
    case "listRecoveryEntries":
      return {
        operation: request.operation,
        value: await stored(dependencies.recovery).list(request.repositoryId, signal),
      };
    case "restoreRecoveryEntry":
      return {
        operation: request.operation,
    ...
    case "listConflicts":
      return {
        operation: request.operation,
        value: await dependencies.conflicts.list(request.repositoryId, signal),
      };
    case "readConflict":
      return {
        operation: request.operation,
        value: await dependencies.conflicts.read(request.repositoryId, request.path, signal),
      };
    case "writeConflictResult":
    ...
    case "resolveWorkingTreeFile":
      return {
        operation: request.operation,
        value: await dependencies.workingTreeFiles.resolve(request.repositoryId, request.path),
      };
    case "executeSynchronizedBranchOperation":
      return {
        operation: request.operation,
        value: await stored(dependencies.multiRoot).executeSynchronizedBranchOperation(
    ...
    case "applyMultiRootRollback":
      return {
        operation: request.operation,
        value: await stored(dependencies.multiRoot).applyMultiRootRollback(request.steps, signal),
      };
  }
}
