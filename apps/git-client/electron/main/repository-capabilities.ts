...
export type ExecutableCapability = "gitMutation" | "terminal" | "hosting" | "externalExecution";

export function safeRepositoryPaths(settings: SettingsStore): ReadonlySet<string> {
