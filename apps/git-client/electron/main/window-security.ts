...
export function installDefaultDenyPermissionPolicy(electronSession: PermissionSession): void {
...
export function isTrustedRendererNavigation(
  ...
  try {
    ...
    if (developmentUrl.username !== "" || developmentUrl.password !== "") return false;
    return (
