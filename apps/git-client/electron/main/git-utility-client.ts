...
export class GitUtilityClient {
  ...
  async openRepository(path: string): Promise<RepositoryRecord> {
    ...
    if (response.kind !== "openRepositoryResult") throw this.#runtime.unexpected(response.kind);
  ...
  async closeRepository(repositoryId: RepositoryId): Promise<boolean> {
    ...
    if (response.kind !== "closeRepositoryResult") throw this.#runtime.unexpected(response.kind);
  ...
  async inspectSnapshot(repositoryId: RepositoryId): Promise<RepositorySnapshot> {
    ...
    if (response.kind !== "inspectSnapshotResult") throw this.#runtime.unexpected(response.kind);
  ...
  async compareBranches(
    ...
    if (result.operation !== "compareBranches") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async preCommitCheck(repositoryId: RepositoryId): Promise<GitPreCommitCheck> {
    ...
    if (result.operation !== "preCommitCheck") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async listGitConfig(repositoryId: RepositoryId): Promise<readonly GitConfigEntry[]> {
    ...
    if (result.operation !== "listGitConfig") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async listSubmodules(repositoryId: RepositoryId): Promise<readonly GitSubmoduleInfo[]> {
    ...
    if (result.operation !== "listSubmodules") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async listMergedBranches(repositoryId: RepositoryId, target: string): Promise<readonly string[]> {
    ...
    if (result.operation !== "listMergedBranches") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async listRemotes(repositoryId: RepositoryId): Promise<readonly GitRemoteInfo[]> {
    ...
    if (result.operation !== "listRemotes") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async listWorktrees(repositoryId: RepositoryId): Promise<readonly GitWorktreeInfo[]> {
    ...
    if (result.operation !== "listWorktrees") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async readIgnoreRules(repositoryId: RepositoryId): Promise<GitIgnoreRules> {
    ...
    if (result.operation !== "readIgnoreRules") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async writeIgnoreRules(repositoryId: RepositoryId, rules: GitIgnoreRules): Promise<void> {
    ...
    if (result.operation !== "writeIgnoreRules") throw this.#runtime.unexpected(result.operation);
  }
  ...
  async loadPushPreview(
    ...
    if (result.operation !== "pushPreview") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async loadSubmoduleDiff(
    ...
    if (result.operation !== "loadSubmoduleDiff") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async exportPatch(
    ...
    if (result.operation !== "exportPatch") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async createPatchText(repositoryId: RepositoryId, revisions: readonly string[]): Promise<string> {
    ...
    if (result.operation !== "createPatchText") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async importPatch(repositoryId: RepositoryId, path: string): Promise<void> {
    ...
    if (result.operation !== "importPatch") throw this.#runtime.unexpected(result.operation);
  }
  ...
  async createShelf(
    ...
    if (result.operation !== "createShelf") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async listShelves(repositoryId: RepositoryId): Promise<readonly GitShelfEntry[]> {
    ...
    if (result.operation !== "listShelves") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async applyShelf(
    ...
    if (result.operation !== "applyShelf") throw this.#runtime.unexpected(result.operation);
  }
  ...
  async deleteShelf(repositoryId: RepositoryId, shelfId: string): Promise<void> {
    ...
    if (result.operation !== "deleteShelf") throw this.#runtime.unexpected(result.operation);
  }
  ...
  async listChangelists(repositoryId: RepositoryId): Promise<readonly GitChangelist[]> {
    ...
    if (result.operation !== "listChangelists") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async saveChangelist(
    ...
    if (result.operation !== "saveChangelist") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async deleteChangelist(repositoryId: RepositoryId, changelistId: string): Promise<void> {
    ...
    if (result.operation !== "deleteChangelist") throw this.#runtime.unexpected(result.operation);
  }
  ...
  async commitChangelist(
    ...
    if (result.operation !== "commitChangelist") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async listConflicts(repositoryId: RepositoryId): Promise<readonly GitConflictFile[]> {
    ...
    if (result.operation !== "listConflicts") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async readConflict(repositoryId: RepositoryId, path: string): Promise<GitConflictContent> {
    ...
    if (result.operation !== "readConflict") throw this.#runtime.unexpected(result.operation);
    return result.value;
  }
  ...
  async readFile(
    ...
    if (response.kind !== "readFileResult") throw this.#runtime.unexpected(response.kind);
  ...
  async readFilePreview(
    ...
    if (response.kind !== "readFilePreviewResult") throw this.#runtime.unexpected(response.kind);
  ...
  async watchRepository(
    ...
    try {
      ...
      if (response.kind !== "watchRepositoryResult") throw this.#runtime.unexpected(response.kind);
  ...
  async unwatchRepository(repositoryId: RepositoryId): Promise<void> {
    ...
    if (response.kind !== "unwatchRepositoryResult") throw this.#runtime.unexpected(response.kind);
    if (response.repositoryId !== id) {
      throw new GitUtilityTransportError(
        "protocolViolation",
  ...
  executeQuery(untrustedRequest: unknown, listener: GitEventListener): Promise<GitTerminalEvent> {
    ...
    return this.#runtime.executeQuery({ kind: "query", correlationId, request }, listener);
  }
  ...
  async #repositoryService(untrustedRequest: unknown): Promise<GitRepositoryServiceResult> {
    ...
    if (response.kind !== "repositoryServiceResult") throw this.#runtime.unexpected(response.kind);
  ...
  async cancelQuery(requestId: string): Promise<boolean> {
    ...
    if (response.kind !== "cancelResult") throw this.#runtime.unexpected(response.kind);
