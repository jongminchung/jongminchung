...
type ClientState = "connecting" | "ready" | "disposing" | "disposed" | "crashed";

function createElectronTransport(child: UtilityProcess): GitUtilityProcessTransport {
  return {
    ...
    subscribeError: (listener) => {
      const receive = (type: "FatalError", location: string) => listener(`${type} at ${location}`);
...
export class GitUtilityClient {
  ...
  readonly #pendingCreations = new Map<UtilityCorrelationId, PendingCreation>();
  ...
  private constructor(
    ...
    const timeoutMs = options.handshakeTimeoutMs ?? GIT_UTILITY_HANDSHAKE_TIMEOUT_MS;
    if (!Number.isSafeInteger(timeoutMs) || timeoutMs <= 0) {
      queueMicrotask(() => {
        this.#crash(
          new GitUtilityTransportError("handshakeTimeout", "Handshake timeout must be positive"),
        );
      });
      return;
    }
    this.#handshakeTimer = setTimeout(() => {
      this.#crash(
        new GitUtilityTransportError("handshakeTimeout", "Git utility handshake timed out"),
      );
    }, timeoutMs);
  ...
  async openRepository(path: string): Promise<RepositoryRecord> {
    ...
    if (response.kind !== "openRepositoryResult") throw this.#unexpected(response.kind);
  ...
  async inspectSnapshot(repositoryId: RepositoryId): Promise<RepositorySnapshot> {
    ...
    if (response.kind !== "inspectSnapshotResult") throw this.#unexpected(response.kind);
  ...
  async compareBranches(
    ...
    if (result.operation !== "compareBranches") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async preCommitCheck(repositoryId: RepositoryId): Promise<GitPreCommitCheck> {
    ...
    if (result.operation !== "preCommitCheck") throw this.#unexpected(result.operation);
    return result.value;
  }

  async listGitConfig(repositoryId: RepositoryId): Promise<readonly GitConfigEntry[]> {
    const result = await this.#repositoryService({
      operation: "listGitConfig",
      repositoryId,
    });
    if (result.operation !== "listGitConfig") throw this.#unexpected(result.operation);
    return result.value;
  }

  async listSubmodules(repositoryId: RepositoryId): Promise<readonly GitSubmoduleInfo[]> {
    const result = await this.#repositoryService({
      operation: "listSubmodules",
      repositoryId,
    });
    if (result.operation !== "listSubmodules") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async listMergedBranches(repositoryId: RepositoryId, target: string): Promise<readonly string[]> {
    ...
    if (result.operation !== "listMergedBranches") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async loadCommitSignature(
    ...
    if (result.operation !== "loadCommitSignature") throw this.#unexpected(result.operation);
    return result.value;
  }

  async listRemotes(repositoryId: RepositoryId): Promise<readonly GitRemoteInfo[]> {
    const result = await this.#repositoryService({
      operation: "listRemotes",
      repositoryId,
    });
    if (result.operation !== "listRemotes") throw this.#unexpected(result.operation);
    return result.value;
  }

  async listWorktrees(repositoryId: RepositoryId): Promise<readonly GitWorktreeInfo[]> {
    const result = await this.#repositoryService({
      operation: "listWorktrees",
      repositoryId,
    });
    if (result.operation !== "listWorktrees") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async readIgnoreRules(repositoryId: RepositoryId): Promise<GitIgnoreRules> {
    ...
    if (result.operation !== "readIgnoreRules") throw this.#unexpected(result.operation);
    return result.value;
  }

  async writeIgnoreRules(repositoryId: RepositoryId, rules: GitIgnoreRules): Promise<void> {
    const result = await this.#repositoryService({
      operation: "writeIgnoreRules",
      repositoryId,
      rules,
    });
    if (result.operation !== "writeIgnoreRules") throw this.#unexpected(result.operation);
  }
  ...
  async loadPushPreview(
    ...
    if (result.operation !== "pushPreview") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async loadHistoryRewritePreview(
    ...
    if (result.operation !== "historyRewritePreview") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async loadSubmoduleDiff(
    ...
    if (result.operation !== "loadSubmoduleDiff") throw this.#unexpected(result.operation);
    return result.value;
  }

  async resolveWorkingTreeFile(repositoryId: RepositoryId, path: string): Promise<string> {
    const result = await this.#repositoryService({
      operation: "resolveWorkingTreeFile",
      repositoryId,
      path,
    });
    if (result.operation !== "resolveWorkingTreeFile") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async applyMultiRootRollback(
    ...
    if (result.operation !== "applyMultiRootRollback") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async exportPatch(
    ...
    if (result.operation !== "exportPatch") throw this.#unexpected(result.operation);
    return result.value;
  }

  async createPatchText(repositoryId: RepositoryId, revisions: readonly string[]): Promise<string> {
    const result = await this.#repositoryService({
      operation: "createPatchText",
      repositoryId,
      revisions,
    });
    if (result.operation !== "createPatchText") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async importPatch(repositoryId: RepositoryId, path: string): Promise<void> {
    ...
    if (result.operation !== "importPatch") throw this.#unexpected(result.operation);
  }
  ...
  async createShelf(
    ...
    if (result.operation !== "createShelf") throw this.#unexpected(result.operation);
    return result.value;
  }

  async listShelves(repositoryId: RepositoryId): Promise<readonly GitShelfEntry[]> {
    const result = await this.#repositoryService({
      operation: "listShelves",
      repositoryId,
    });
    if (result.operation !== "listShelves") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async applyShelf(
    ...
    if (result.operation !== "applyShelf") throw this.#unexpected(result.operation);
  }

  async deleteShelf(repositoryId: RepositoryId, shelfId: string): Promise<void> {
    const result = await this.#repositoryService({
      operation: "deleteShelf",
      repositoryId,
      shelfId,
    });
    if (result.operation !== "deleteShelf") throw this.#unexpected(result.operation);
  }

  async listChangelists(repositoryId: RepositoryId): Promise<readonly GitChangelist[]> {
    const result = await this.#repositoryService({
      operation: "listChangelists",
      repositoryId,
    });
    if (result.operation !== "listChangelists") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async saveChangelist(
    ...
    if (result.operation !== "saveChangelist") throw this.#unexpected(result.operation);
    return result.value;
  }

  async deleteChangelist(repositoryId: RepositoryId, changelistId: string): Promise<void> {
    const result = await this.#repositoryService({
      operation: "deleteChangelist",
      repositoryId,
      changelistId,
    });
    if (result.operation !== "deleteChangelist") throw this.#unexpected(result.operation);
  }
  ...
  async commitChangelist(
    ...
    if (result.operation !== "commitChangelist") throw this.#unexpected(result.operation);
    return result.value;
  }

  async listRecoveryEntries(repositoryId: RepositoryId): Promise<readonly GitRecoveryEntry[]> {
    const result = await this.#repositoryService({
      operation: "listRecoveryEntries",
      repositoryId,
    });
    if (result.operation !== "listRecoveryEntries") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async restoreRecoveryEntry(
    ...
    if (result.operation !== "restoreRecoveryEntry") throw this.#unexpected(result.operation);
    return result.value;
  }

  async listConflicts(repositoryId: RepositoryId): Promise<readonly GitConflictFile[]> {
    const result = await this.#repositoryService({
      operation: "listConflicts",
      repositoryId,
    });
    if (result.operation !== "listConflicts") throw this.#unexpected(result.operation);
    return result.value;
  }

  async readConflict(repositoryId: RepositoryId, path: string): Promise<GitConflictContent> {
    const result = await this.#repositoryService({
      operation: "readConflict",
      repositoryId,
      path,
    });
    if (result.operation !== "readConflict") throw this.#unexpected(result.operation);
    return result.value;
  }
  ...
  async writeConflictResult(
    ...
    if (result.operation !== "writeConflictResult") throw this.#unexpected(result.operation);
  }
  ...
  async resolveBinaryConflict(
    ...
    if (result.operation !== "resolveBinaryConflict") throw this.#unexpected(result.operation);
  }
  ...
  async readFile(
    ...
    if (response.kind !== "readFileResult") throw this.#unexpected(response.kind);
  ...
  async readFilePreview(
    ...
    if (response.kind !== "readFilePreviewResult") throw this.#unexpected(response.kind);
  ...
  async writeWorkingTreeFile(
    ...
    if (response.kind !== "writeWorkingTreeFileResult") throw this.#unexpected(response.kind);
  }
  ...
  async watchRepository(
    ...
    try {
      ...
      if (response.kind !== "watchRepositoryResult") throw this.#unexpected(response.kind);
      ...
      if (this.#watchListeners.get(id) === listener) this.#watchListeners.delete(id);
      throw error;
    }
  }
  ...
  async unwatchRepository(repositoryId: RepositoryId): Promise<void> {
    ...
    if (response.kind !== "unwatchRepositoryResult") throw this.#unexpected(response.kind);
    if (response.repositoryId !== id) {
      throw new GitUtilityTransportError(
        "protocolViolation",
  ...
  #executeCreation(
    ...
    const promise = new Promise<GitCreationTerminalEvent>((resolve, reject) => {
  ...
  async #repositoryService(untrustedRequest: unknown): Promise<GitRepositoryServiceResult> {
    this.#assertReady();
    ...
    if (response.kind !== "repositoryServiceResult") throw this.#unexpected(response.kind);
  ...
  async cancelQuery(requestId: string): Promise<boolean> {
    ...
    if (response.kind !== "cancelResult") throw this.#unexpected(response.kind);
  ...
  dispose(): Promise<void> {
    ...
    this.#disposePromise = responsePromise
      .then((response) => {
        ...
        const error = new GitUtilityTransportError("disposed", "Git utility client was disposed");
        this.#rejectOutstanding(error);
        this.#cleanUpSubscriptions();
        this.#transport.kill();
      })
      .catch((error: unknown) => {
        const failure = error instanceof Error ? error : new Error("Unable to dispose Git utility");
        this.#crash(failure);
        throw failure;
      });
  ...
  #request(
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        reject(error instanceof Error ? error : new Error("Unable to send Git utility message"));
      }
    });
  }

  #receive(untrustedMessage: unknown): void {
    const parsed = GitUtilityToMainMessageSchema.safeParse(untrustedMessage);
    if (!parsed.success) {
      this.#crash(
        new GitUtilityTransportError("protocolViolation", "Git utility sent an invalid message"),
      );
      return;
    }
  ...
  #ready(message: Extract<GitUtilityToMainMessage, Readonly<{ kind: "ready" }>>): void {
    if (this.#state !== "connecting" || this.#instanceId !== null) {
      this.#crash(
        new GitUtilityTransportError("protocolViolation", "Unexpected Git utility ready message"),
      );
      return;
    }
  ...
  #handshakeAck(
    message: Extract<GitUtilityToMainMessage, Readonly<{ kind: "handshakeAck" }>>,
  ): void {
    if (
  ...
  #queryEvent(correlationId: UtilityCorrelationId, event: GitRequestEvent): void {
    const pending = this.#pendingQueries.get(correlationId);
    if (pending === undefined || event.requestId !== pending.requestId) {
      this.#crash(
        new GitUtilityTransportError("protocolViolation", "Uncorrelated Git query event"),
      );
      return;
    }
    if (event.kind === "started") {
      if (pending.phase !== "awaitingStarted") {
        this.#crash(
          new GitUtilityTransportError("protocolViolation", "Duplicate Git query start event"),
        );
        return;
      }
      pending.phase = "running";
    } else if (event.kind === "output") {
      if (pending.phase !== "running" || event.sequence !== pending.nextSequence) {
        this.#crash(
          new GitUtilityTransportError("protocolViolation", "Out-of-order Git query output event"),
        );
        return;
      }
      ...
      this.#crash(
        new GitUtilityTransportError("protocolViolation", "Git query terminated before starting"),
      );
      return;
    }
    try {
  ...
  #creationEvent(correlationId: UtilityCorrelationId, event: GitCreationEvent): void {
    ...
    if (
      ...
      this.#crash(
        new GitUtilityTransportError("protocolViolation", "Uncorrelated Git creation event"),
      );
      return;
    }
    if (event.kind === "started") {
      if (pending.phase !== "awaitingStarted") {
        this.#crash(
          new GitUtilityTransportError("protocolViolation", "Duplicate Git creation start event"),
        );
        return;
      }
      pending.phase = "running";
      ...
      if (pending.phase !== "running" || event.sequence !== pending.nextSequence) {
        this.#crash(
          new GitUtilityTransportError("protocolViolation", "Out-of-order Git creation event"),
        );
        return;
      }
      pending.nextSequence += 1;
  ...
  #commandResult(
    ...
    if (pending === undefined || pending.expectedKind !== message.kind) {
      this.#crash(
        new GitUtilityTransportError("protocolViolation", "Uncorrelated Git utility response"),
      );
      return;
    }
    this.#pendingCommands.delete(message.correlationId);
  ...
  #remoteError(
    ...
    this.#crash(
      new GitUtilityTransportError("protocolViolation", "Uncorrelated Git utility error"),
    );
  }
  ...
  #processErrored(message: string): void {
    this.#crash(new GitUtilityTransportError("utilityFatalError", message), false);
  }

  #send(message: MainToGitUtilityMessage): void {
    this.#transport.postMessage(MainToGitUtilityMessageSchema.parse(message));
  }
  ...
  #rejectOutstanding(error: Error): void {
    ...
    for (const pending of this.#pendingCreations.values()) pending.reject(error);
