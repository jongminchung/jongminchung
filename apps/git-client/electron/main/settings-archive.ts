...
import { JsonValueSchema, type JsonValue } from "../../src/shared/contracts/ipc";
...
export function parseImportedSettings(bytes: Uint8Array): Readonly<Record<string, JsonValue>> {
