export interface RepositoryCommandContext {
  readonly setScratchFileChooserOpen: (value: import("react").SetStateAction<boolean>) => void;
  readonly setExportToHtmlOpen: (value: import("react").SetStateAction<boolean>) => void;
  readonly inspector: import("../state/workspaceTypes").InspectorState | undefined;
  ...
  readonly setBookmarksOpen: (value: import("react").SetStateAction<boolean>) => void;
  readonly setProjectOpen: (value: import("react").SetStateAction<boolean>) => void;
  ...
  readonly setLogTabIds: (value: import("react").SetStateAction<readonly string[]>) => void;
  readonly setLogOpen: (value: import("react").SetStateAction<boolean>) => void;
  readonly setActiveLogTabId: (value: import("react").SetStateAction<string>) => void;
  ...
  readonly editorStatus: import("../state/workspaceTypes").EditorStatus | undefined;
  readonly editorActionAvailability: (
    requiresEditable: boolean,
  ) => ReturnType<import("../../domain/commands").CommandDefinition["availability"]>;
  readonly activeToolWindow: import("../state/workspaceTypes").RepositoryToolWindow | null;
  readonly setBottomCollapsed: (value: import("react").SetStateAction<boolean>) => void;
  ...
  readonly setSideToolWindowWidth: (value: import("react").SetStateAction<number>) => void;
  readonly setBottomPanelHeight: (value: import("react").SetStateAction<number>) => void;
  ...
  readonly setBalloonId: (value: import("react").SetStateAction<string | undefined>) => void;
  readonly setNotificationOpen: (value: import("react").SetStateAction<boolean>) => void;
  readonly notificationOpen: boolean;
  readonly openPaletteFor: (scope: import("../../domain/commands").PaletteScope) => void;
  readonly setProjectSearchInitialQuery: (value: import("react").SetStateAction<string>) => void;
  readonly setProjectSearchSurface: (
    value: import("react").SetStateAction<
      import("../../components/ProjectSearchDialog").ProjectSearchSurface | undefined
    >,
  ) => void;
  ...
  >;
  readonly setReplaceInFilesOpen: (value: import("react").SetStateAction<boolean>) => void;
  readonly setRecentFindUsagesOpen: (value: import("react").SetStateAction<boolean>) => void;
  ...
  readonly setRunInspectionOpen: (value: import("react").SetStateAction<boolean>) => void;
  ...
  readonly setStackTraceOpen: (value: import("react").SetStateAction<boolean>) => void;
  ...
  readonly openLineBookmark: (bookmark: import("../../domain/bookmarks").LineBookmark) => void;
  readonly setBookmarksPopupMode: (
    value: import("react").SetStateAction<
      import("../../components/BookmarksPopup").BookmarksPopupMode | undefined
    >,
  ) => void;
  ...
  readonly setProcessesOpen: (value: import("react").SetStateAction<boolean>) => void;
  readonly processesOpen: boolean;
  readonly changeSelection: import("../../domain/changeReview").ChangeSelection | null;
  ...
  readonly setToast: (value: import("react").SetStateAction<string | undefined>) => void;
  readonly workingEntries: readonly import("../../domain/changeReview").ChangeEntry[];
  readonly requestShareProject: (provider: "gitHub" | "gitLab") => Promise<void>;
  ...
  readonly setVcsOperationsOpen: (value: import("react").SetStateAction<boolean>) => void;
  ...
  readonly openConflict: (file: import("../../domain/types").FileChange) => void;
  readonly runAction: (
    action: keyof import("../../domain/types").ActionAvailability,
  ) => Promise<void>;
  readonly availability: import("../../domain/types").ActionAvailability;
  readonly maximizedToolWindow: import("../state/workspaceTypes").RepositoryToolWindow | null;
