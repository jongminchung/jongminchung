...
import { editorPanelDomId, editorTabDomId } from "../hooks/useRepositoryTabCoordinator";
          ...
          <Button
            ...
            onClick={toVoidHandler(async () => {
              const accepted = await dialog.confirm({
                ...
                description: "Restores the state recorded before the in-progress Git operation.",
