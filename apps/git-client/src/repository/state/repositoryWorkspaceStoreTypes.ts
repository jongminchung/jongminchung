...
import type { CommitSignature, ConflictContent } from "../../shared/contracts/model";
import type {
  BookmarkGroupTarget,
...
export interface ReviewSlice {
  ...
  readonly setContextPosition: RepositoryStateSetter<ContextPosition | undefined>;
  readonly setDiffState: RepositoryStateSetter<DiffState | undefined>;
  readonly setRevisionComparison: RepositoryStateSetter<RevisionComparisonState | undefined>;
  readonly setConflictContent: RepositoryStateSetter<ConflictContent | undefined>;
  ...
  readonly setCommitSignature: RepositoryStateSetter<CommitSignature | undefined>;
...
export interface EditorToolsSlice {
  ...
  readonly codeAnalysisRequest:
    | { readonly mode: "inspect" | "cleanup"; readonly inspectionId?: CodeInspectionId }
    | undefined;
  ...
  readonly setRecentInspectors: RepositoryStateSetter<readonly InspectorState[]>;
  ...
  readonly setProjectSearchSurface: RepositoryStateSetter<ProjectSearchSurface | undefined>;
  ...
  readonly setRecentFindUsages: RepositoryStateSetter<readonly FindResultsSession[]>;
  readonly setRecentFindUsagesOpen: RepositoryStateSetter<boolean>;
  readonly setCodeAnalysisRequest: RepositoryStateSetter<EditorToolsSlice["codeAnalysisRequest"]>;
  ...
  readonly setInspectionResults: RepositoryStateSetter<EditorToolsSlice["inspectionResults"]>;
  ...
  readonly setBookmarksPopupMode: RepositoryStateSetter<BookmarksPopupMode | undefined>;
  readonly setBookmarkMnemonicTarget: RepositoryStateSetter<BookmarkMnemonicTarget | undefined>;
  readonly setBookmarkGroupTarget: RepositoryStateSetter<BookmarkGroupTarget | undefined>;
...
export interface LayoutSlice {
  ...
  readonly setShareProjectProvider: RepositoryStateSetter<ShareProjectProvider | undefined>;
  readonly setShareExistingRemotes: RepositoryStateSetter<ShareExistingRemotes | undefined>;
  readonly setNotifications: RepositoryStateSetter<readonly ProductNotification[]>;
...
export type RepositoryWorkspaceSliceCreator<T> = StateCreator<RepositoryWorkspaceStore, [], [], T>;
