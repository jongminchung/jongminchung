...
describe("workspace persistence", () => {
  ...
  it("selects the adjacent session when the active repository closes", () => {
    expect(
      workspaceTabAfterClose(sessions, { kind: "repository", repositoryId: "repo-a" }, "repo-a"),
    ).toEqual({ kind: "error", sessionId: "error:/missing" });
    expect(
      workspaceTabAfterClose(sessions, { kind: "repository", repositoryId: "repo-b" }, "repo-b"),
    ).toEqual({ kind: "error", sessionId: "error:/missing" });
    expect(
      workspaceTabAfterClose(sessions, { kind: "repository", repositoryId: "repo-b" }, "repo-a"),
