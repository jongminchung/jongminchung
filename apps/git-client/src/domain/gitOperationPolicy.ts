import type { GitOperation, RepositoryInvalidation } from "../shared/contracts/model";
...
export function operationPolicyFor(operation: Pick<GitOperation, "kind">): GitOperationPolicy {
