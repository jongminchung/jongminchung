...
import { FIXTURE_REPOSITORY_ACTION_ERROR, assertLiveRepositoryActionAllowed } from "./fixtureMode";
...
describe("assertLiveRepositoryActionAllowed", () => {
  it("prevents a real repository from becoming a permanently loading fixture session", () => {
    expect(() => assertLiveRepositoryActionAllowed(true)).toThrow(FIXTURE_REPOSITORY_ACTION_ERROR);
  });
