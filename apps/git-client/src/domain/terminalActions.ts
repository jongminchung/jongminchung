...
export type TerminalSurfaceActionId = Exclude<
    TerminalActionId,
    "newTab" | "closeTab"
>;
...
export function terminalActionForKeyboard(
...
export class TerminalActionExecutor {
    ...
    async #copy(): Promise<TerminalActionResult> {
        ...
        if (selection.length === 0) {
            return {
                kind: "unavailable",
                reason: "Select terminal text before copying.",
            };
        }
        ...
        try {
            ...
            return {
                kind: "unavailable",
                reason: "Terminal text could not be copied.",
            };
        }
    }
    ...
    async #paste(): Promise<TerminalActionResult> {
        ...
        try {
            ...
            return {
                kind: "unavailable",
                reason: "Clipboard text could not be pasted.",
            };
        }
    }
}
