...
describe("appearance", () => {
    ...
    it("resolves system changes while manual modes remain fixed", () => {
        ...
        expect(
            resolveAppearance({ theme: "light", syncWithOs: true }, true),
        ).toBe("dark");
        expect(
            resolveAppearance({ theme: "light", syncWithOs: false }, true),
        ).toBe("light");
        expect(
            resolveAppearance({ theme: "dark", syncWithOs: false }, false),
        ).toBe("dark");
    });
