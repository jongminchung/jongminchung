import type { HistoryRewritePreview, InProgressOperation } from "../shared/contracts/model";
...
export function protectedRewriteConfirmation(preview: HistoryRewritePreview): RecoveryConfirmation {
  return {
