...
interface RepositoryEditorTabsProps {
  ...
  readonly sessionExecuteOperation: GitSessionCapabilities["mutations"]["executeOperation"];
  readonly sessionLoading: boolean;
  readonly sessionReload: GitSessionCapabilities["queries"]["reload"];
