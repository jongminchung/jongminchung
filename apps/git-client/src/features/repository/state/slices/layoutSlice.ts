...
export const createLayoutSlice = (
    ...
    ((set) => ({
        ...
        setBottomCollapsed: (value) =>
            set((state) => ({
                bottomCollapsed: resolveRepositoryState(
                    value,
        ...
        setBookmarksOpen: (value) =>
            set((state) => ({
                bookmarksOpen: resolveRepositoryState(
                    value,
                    state.bookmarksOpen,
                ),
            })),
        ...
        setActiveLogTabId: (value) =>
            set((state) => ({
                activeLogTabId: resolveRepositoryState(
                    value,
        ...
        setBottomPanelTab: (value) =>
            set((state) => ({
                bottomPanelTab: resolveRepositoryState(
                    value,
        ...
        setCommitRailWidth: (value) =>
            set((state) => ({
                commitRailWidth: resolveRepositoryState(
                    value,
                    state.commitRailWidth,
                ),
            })),
        setToast: (value) =>
            set((state) => ({
        ...
        setNotificationOpen: (value) =>
            set((state) => ({
                notificationOpen: resolveRepositoryState(
                    value,
        ...
        setProcessesOpen: (value) =>
            set((state) => ({
                processesOpen: resolveRepositoryState(
                    value,
                    state.processesOpen,
                ),
            })),
        setActiveToolWindow: (value) =>
            set((state) => ({
                activeToolWindow: resolveRepositoryState(
                    value,
                    state.activeToolWindow,
                ),
            })),
        ...
        setNotifications: (value) =>
            set((state) => ({
                notifications: resolveRepositoryState(
                    value,
                    state.notifications,
                ),
            })),
        ...
        setUiStateRestored: (value) =>
            set((state) => ({
                uiStateRestored: resolveRepositoryState(
                    value,
                    state.uiStateRestored,
                ),
            })),
