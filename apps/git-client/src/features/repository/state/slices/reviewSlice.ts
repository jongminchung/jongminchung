...
export const createReviewSlice = (
  ...
  ((set) => ({
    ...
    setChangeSelection: (value) =>
      set((state) => ({
        changeSelection: resolveRepositoryState(value, state.changeSelection),
      })),
    ...
    setDiffPreferences: (value) =>
      set((state) => ({
        diffPreferences: resolveRepositoryState(value, state.diffPreferences),
      })),
    ...
    setHistoryPreview: (value) =>
      set((state) => ({
        historyPreview: resolveRepositoryState(value, state.historyPreview),
      })),
    setChangePreview: (value) =>
      set((state) => ({
        changePreview: resolveRepositoryState(value, state.changePreview),
      })),
    setHistoryContent: (value) =>
      set((state) => ({
        historyContent: resolveRepositoryState(value, state.historyContent),
      })),
    setChangeContent: (value) =>
      set((state) => ({
        changeContent: resolveRepositoryState(value, state.changeContent),
      })),
    ...
    setChangeSubmodule: (value) =>
      set((state) => ({
        changeSubmodule: resolveRepositoryState(value, state.changeSubmodule),
      })),
    setContextPosition: (value) =>
      set((state) => ({
        contextPosition: resolveRepositoryState(value, state.contextPosition),
      })),
    setDiffState: (value) =>
      set((state) => ({
    ...
    setConflictContent: (value) =>
      set((state) => ({
        conflictContent: resolveRepositoryState(value, state.conflictContent),
      })),
    ...
    setCommitSignature: (value) =>
      set((state) => ({
        commitSignature: resolveRepositoryState(value, state.commitSignature),
      })),
    setHistoryRewrite: (value) =>
      set((state) => ({
        historyRewrite: resolveRepositoryState(value, state.historyRewrite),
      })),
