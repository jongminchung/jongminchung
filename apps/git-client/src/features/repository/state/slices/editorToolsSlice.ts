...
export const createEditorToolsSlice = (
  ...
  ((set) => ({
    ...
    setInspectorTabs: (value) =>
      set((state) => ({
        inspectorTabs: resolveRepositoryState(value, state.inspectorTabs),
      })),
    ...
    setNavigationIndex: (value) =>
      set((state) => ({
        navigationIndex: resolveRepositoryState(value, state.navigationIndex),
      })),
    ...
    setExportToHtmlOpen: (value) =>
      set((state) => ({
        exportToHtmlOpen: resolveRepositoryState(value, state.exportToHtmlOpen),
      })),
    ...
    setStackTraceOpen: (value) =>
      set((state) => ({
        stackTraceOpen: resolveRepositoryState(value, state.stackTraceOpen),
      })),
