...
const BookmarkGroupSelectDialog = lazy(() =>
    import("../../../components/BookmarkGroupSelectDialog").then(
...
const BookmarkMnemonicDialog = lazy(() =>
    import("../../../components/BookmarkMnemonicDialog").then(
...
const CodeAnalysisScopeDialog = lazy(() =>
    import("../../../components/CodeAnalysisScopeDialog").then(
...
const ExportToHtmlDialog = lazy(() =>
    import("../../../components/ExportToHtmlDialog").then(
        ({ ExportToHtmlDialog }) => ({
...
const InspectionResultsDialog = lazy(() =>
    import("../../../components/InspectionResultsDialog").then(
...
const ProcessesDialog = lazy(() =>
    import("../../../components/ProcessesDialog").then(
        ({ ProcessesDialog }) => ({
...
const ProjectSearchDialog = lazy(() =>
    import("../../../components/ProjectSearchDialog").then(
        ({ ProjectSearchDialog }) => ({
...
const RecentFindUsagesDialog = lazy(() =>
    import("../../../components/RecentFindUsagesDialog").then(
...
const ReplaceInFilesDialog = lazy(() =>
    import("../../../components/ReplaceInFilesDialog").then(
...
const RunInspectionDialog = lazy(() =>
    import("../../../components/RunInspectionDialog").then(
        ({ RunInspectionDialog }) => ({
...
const ScratchFileChooserDialog = lazy(() =>
    import("../../../components/ScratchFileChooserDialog").then(
...
const StackTraceDialog = lazy(() =>
    import("../../../components/StackTraceDialog").then(
        ({ StackTraceDialog }) => ({
...
const VcsOperationsPopup = lazy(() =>
    import("../../../components/VcsOperationsPopup").then(
        ({ VcsOperationsPopup }) => ({
...
interface RepositoryOverlaysProps {
    ...
    readonly cancelActivity: ComponentProps<
        typeof ProcessesDialog
    >["onCancelActivity"];
    ...
    readonly createScratchFile: ComponentProps<
        typeof ScratchFileChooserDialog
    >["onChoose"];
    readonly executeCommand: ComponentProps<
        typeof VcsOperationsPopup
    >["onExecute"];
    readonly exportToHtml: ComponentProps<
        typeof ExportToHtmlDialog
    >["onExport"];
    readonly inspector: InspectorState | undefined;
    readonly openCodeIssue: ComponentProps<
        typeof InspectionResultsDialog
    >["onOpenIssue"];
    readonly openInspector: (next: InspectorState, keepOpen?: boolean) => void;
    readonly openLineBookmark: ComponentProps<
        typeof BookmarksPopup
    >["onOpenBookmark"];
    readonly openStackFrame: ComponentProps<
        typeof StackTraceDialog
    >["onOpenFrame"];
    readonly productSettings: ProductSettings;
    readonly replaceInProjectFiles: ComponentProps<
        typeof ReplaceInFilesDialog
    >["onReplace"];
    readonly repository: RepositoryView;
    readonly runCodeCleanup: (scope: CodeAnalysisScope) => Promise<void>;
    readonly runCodeInspection: (
        scope: CodeAnalysisScope,
        id?: CodeInspectionId,
    ) => Promise<void>;
    readonly searchProjectText: GitSessionCapabilities["queries"]["searchProjectText"];
    readonly vcsOperationGroups: ComponentProps<
        typeof VcsOperationsPopup
    >["groups"];
}
