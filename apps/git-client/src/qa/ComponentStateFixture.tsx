      ...
      <GitClientTheme>
        <main className="h-full overflow-auto bg-background p-6 text-foreground">
          <header className="mb-6">
            <h1 className="text-xl font-semibold">Component state fixture</h1>
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] gap-4">
            ...
            <StateGroup title="Fields">
              <Field>
                <FieldLabel htmlFor="fixture-name">Repository name</FieldLabel>
                <FieldDescription>
                ...
                />
                <FieldError>Use an owner/repository value</FieldError>
              </Field>
            ...
            <StateGroup title="Overlay matrix">
              <div className="flex flex-wrap items-start gap-3">
                <Select defaultValue="main" open={openOverlay === "select"}>
              ...
              <Dialog open={openOverlay === "dialog"}>
                ...
                <DialogContent closeLabel="Close fixture dialog">
                  ...
                  <DialogDescription>
                    Focus and stacking use the production primitive
                  </DialogDescription>
                </DialogContent>
              </Dialog>
            </StateGroup>
