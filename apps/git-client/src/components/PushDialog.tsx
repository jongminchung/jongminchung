                    ...
                    <section className="grid grid-cols-2 gap-3 max-[600px]:grid-cols-1">
                        <Selector
                            ...
                            options={[
                                ...
                                ...(remote &&
                                !remotes.some((item) => item.name === remote)
                        ...
                        <label className="grid gap-1 text-xs text-muted-foreground">
                            ...
                            <Input
                                ...
                                onChange={(event) =>
                                    setRemoteRef(event.target.value)
                                }
                                value={remoteRef}
                            />
                        </label>
                    ...
                    {loading ? (
                        ...
                        <>
                            <section className="grid grid-cols-[auto_1fr] gap-x-3 gap-y-1 rounded-lg border border-border bg-muted p-3 text-xs">
                                ...
                                <strong>
                                    {preview.ahead} ahead · {preview.behind}{" "}
                                    behind
                                </strong>
                                <span className="text-muted-foreground">
                                    Expected lease
                            ...
                            {reviewExpired && (
                                ...
                                >
                                    <span>
                                        Destination review expired. Review the
                                        destination again to fetch a new exact
                            ...
                            {preview.remoteStateError && (
                                ...
                                >
                                    <span>
                                        {preview.remoteStateError} Normal push
                                        remains available; force push is
                                        disabled.
                                    </span>
                                </Notice>
                            )}
                            {preview.fastForward === false && (
                                ...
                                >
                                    <span>
                                        ...
                                        Normal push cannot update this
                                        destination.
                                    </span>
                                </Notice>
                            )}
                            ...
                            {choice === "forceWithLease" && (
                                <Notice role="alert" tone="destructive">
                                    <section className="grid gap-2">
                                        ...
                                        <span>
                                            {shortOid(preview.remoteOid)} →{" "}
                                            {shortOid(preview.localOid)} on{" "}
                                            {preview.remoteRef}
                                        </span>
                                        <span>
                                            {preview.remoteOnlyCommits.length}{" "}
                                            remote-only commit(s) may no longer
                                            be reachable from this branch.
                                        </span>
                                        {preview.remoteOnlyCommits
                                            .slice(0, 8)
                                            .map((commit) => (
                                                <code key={commit.oid}>
                            ...
                            <section className="grid gap-2">
                                <div className="flex items-center gap-2">
                                    <strong>
                                        {preview.commits.length} commit(s) to
                                        push
                                    </strong>
