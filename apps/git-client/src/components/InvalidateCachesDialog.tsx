    ...
    return (
        ...
        >
            ...
            >
                ...
                <main>
                    <p>
                        Remove caches and indexes for all projects. New caches
                        will be built when you reopen the projects.
                    </p>
                    <p>
                        Project files, Git history, local settings, accounts,
                        and Local History are not removed.
                    </p>
                </main>
                <footer>
                    <Button
