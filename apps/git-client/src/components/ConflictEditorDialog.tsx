...
export function ConflictEditorDialog({
    ...
    const requestAbort = useCallback(async (): Promise<void> => {
        if (!operation || operation === "bisect" || pendingAction !== null)
            return;
        const accepted = await confirm(
            abortOperationConfirmation(
                operation,
                ...
                <section className="relative grid h-[min(760px,calc(100vh-50px))] min-h-0 grid-rows-[auto_minmax(0,1fr)] overflow-hidden">
                    ...
                    {content.binary ? (
                        ...
                        >
                            ...
                            <p>
                                The file cannot be safely represented as UTF-8
                                text. Choose one complete side.
                            </p>
                            <div>
                                <Button
                                ...
                                <Button
                                    ...
                                    type="button"
                                    onClick={() => {
                                        void runAction("theirs", () =>
                                            onResolveBinary("theirs"),
                                        );
                                    }}
                                    className={cn("h-8 px-3")}
                                    variant="outline"
