...
export function DiffViewer({
  ...
  const updateStatistics = useCallback(
    (next: { readonly differences: number; readonly matches: number }): void =>
      setStatistics(next),
    [],
  );
    ...
    >
      ...
      >
        ...
        >
          ...
          {searchQuery && (
            <small>
              {matchCount > 0 ? `${searchMatchIndex + 1}/${matchCount}` : "0"}
            </small>
          )}
        </label>
        {onToggleFocus && (
        ...
        {mode !== "readOnly" && (
          <>
            <Select
              ...
              value={String(
                Math.min(hunkIndex, Math.max(0, document.hunks.length - 1)),
              )}
            >
              <SelectTrigger
            ...
            <Button
              disabled={
                hunk === null || selectedLines.size === 0 || !onApplyPatch
              }
        ...
        {loading ? (
          ...
          >
            ...
            {submoduleDiff.ahead !== null && submoduleDiff.behind !== null ? (
              ...
              <p>
                Commit relationship is unavailable because one or both objects
