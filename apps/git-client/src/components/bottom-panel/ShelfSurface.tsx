  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <strong>Shelf</strong>
          <p>Index, worktree, and untracked files are stored atomically outside the repository.</p>
        </div>
        <Button
      ...
      {shelves.map((shelf) => (
        ...
        >
          ...
          <div>
            ...
            <small>
              {new Date(shelf.createdAtMs).toLocaleString()} · {shelf.files.length} files · checksum
              verified
            </small>
          </div>
          <Button
          ...
          <Button
            ...
            onClick={toVoidHandler(async () => {
              const accepted = await dialog.confirm({
                ...
                description: "The stored patches and untracked file copies will be deleted.",
