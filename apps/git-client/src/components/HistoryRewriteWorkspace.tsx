      ...
      current.map((entry) =>
        entry.oid === oid
          ? {
              ...
              action,
              message:
                action === "reword" ? (entry.message ?? entry.subject) : null,
            }
          : entry,
      ),
    );
      ...
      >
        ...
        >
          ...
          {loading ? (
            ...
            <div className="m-auto grid max-w-xl gap-4 rounded-lg border border-border bg-card p-6 text-center">
              ...
              <p className="m-0 text-muted-foreground">
                {preview.branch} was rewritten locally. A Recovery entry was
            ...
            <div className="grid min-h-0 grid-cols-[minmax(0,1fr)_320px] max-[900px]:grid-cols-1 max-[900px]:grid-rows-[minmax(0,1fr)_auto]">
                      ...
                      >
                        ...
                        <TableCell className="p-2">
                          <Select
                            ...
                            onValueChange={(value) =>
                              value &&
                              changeAction(entry.oid, value as RebasePlanAction)
                            }
                            value={entry.action}
                          >
                            <SelectTrigger
              ...
              <aside className="grid content-start gap-4 overflow-auto bg-card p-4">
                <section className="grid gap-2">
                  ...
                  <span>
                    {preview.dependentRefs.length} dependent local ref(s)
                  </span>
                  <span>
                    {preview.root
                ...
                <small className="text-muted-foreground">
                  Conflicts and edit stops continue in Changes / Recovery with
          ...
          <DialogFooter alignment="start">
            ...
            {validation && (
              <small className="text-destructive">{validation}</small>
            )}
            {error && preview && (
