      ...
      >
        ...
        >
          <span>
            {loading
              ? "Searching…"
              : `${matches.length} matches in ${files.length} files`}
          </span>
          {files.length > 0 && (
            <Button
              onClick={() =>
                setSelectedPaths(
                  new Set(selectedPaths.size === files.length ? [] : files),
                )
              }
              type="button"
        ...
        >
          {loading ? (
            ...
            <p>
              {query ? "Nothing found" : "Enter text to find in the project."}
            </p>
          ) : (
        ...
        <footer>
          ...
          <Button
            ...
            type="button"
            disabled={
              loading || replacing || selectedPaths.size === 0 || query === ""
            }
            className={cn("h-8 px-3")}
            variant="default"
            size="default"
