...
const MNEMONICS = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".split(
    "",
) as BookmarkMnemonic[];
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    {MNEMONICS.map((mnemonic) => (
                        <Button
                            ...
                            data-assigned={
                                assigned.has(mnemonic) && mnemonic !== current
                                    ? "true"
                                    : undefined
                            }
                            key={mnemonic}
                ...
                />
                <p>
                    Type or double-click a mnemonic to set it. Already used
                    mnemonics are marked.
                </p>
                <footer>
                    <Button
                        onClick={onClose}
