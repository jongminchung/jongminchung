        ...
        >
            ...
            >
                ...
                <main aria-busy={state.kind === "running"}>
                    ...
                    <p>
                        Refresh the repository snapshot, file inventory, Git log
                        indexes, and editor metadata without changing project
                        files.
                    </p>
                    {state.kind === "running" && (
                    ...
                    {state.kind === "completed" && (
                        <p role="status">
                            The recovery step completed. Check whether the
