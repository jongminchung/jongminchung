                ...
                content={
                    ...
                    >
                        ...
                        <CheckboxInput
                            ...
                            onChange={(value) =>
                                onChange("compactReferences", value)
                            }
                            size="sm"
                        ...
                        <CheckboxInput
                            ...
                            onChange={(value) =>
                                onChange("preferCommitDate", value)
                            }
                            size="sm"
                        ...
                        <CheckboxInput
                            ...
                            onChange={(value) =>
                                onChange("referencesOnLeft", value)
                            }
                            size="sm"
