...
function commitTime(
    timestamp: number,
    relativeTimeBaseSeconds?: number,
): string {
        ...
        >
            ...
            {filtered.length === 0 ? (
                loading ? (
                    ...
                    <Notice
                        className="m-auto w-auto max-w-lg"
                        role="alert"
                        size="sm"
                        tone="destructive"
                    >
                ...
                <div
                    style={{
                        height:
                            filtered.length * LOG_ROW_HEIGHT +
                            (loading || error ? LOG_ROW_HEIGHT : 0),
                        position: "relative",
                    }}
                >
                    <div
                    ...
                    >
                        <CommitGraph
                            commits={filtered}
                            width={34}
                            showLongEdges={viewOptions.showLongEdges}
                        />
                    </div>
