...
export function imageFrom(preview: FilePreview | null | undefined): ImagePreview | null {
  return preview?.kind === "image" ? preview.preview : null;
}

export function previewDescription(preview: FilePreview | null | undefined): string {
