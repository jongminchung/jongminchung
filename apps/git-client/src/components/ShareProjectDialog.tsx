    ...
    try {
      ...
      if (repository === null) {
        const response = await bridge.execute(accountId, {
          ...
          private: isPrivate,
          namespaceId:
            provider === "gitLab" ? (selectedNamespace?.id ?? null) : null,
        });
    ...
    >
      ...
      >
        ...
        <main>
              ...
              <Tooltip>
                <TooltipTrigger
                  render={
                    <Button
                      onClick={() =>
                        setNamespaceRefreshToken((value) => value + 1)
                      }
                      type="button"
          ...
          {created && (
            <p role="status">
              Remote repository created at <code>{created.project}</code>.
              Retrying will only finish local Git setup.
            </p>
          )}
