...
export function RepositoryInspectorDialog({
            ...
            try {
                if (tab === "tree")
                    ...
                    if (nextContent.kind === "text")
                        setEditorValue(nextContent.content);
    ...
    const surface = (
        <section
            aria-label={
                embedded ? `Editor: ${path || "Repository"}` : undefined
            }
            className={
                embedded
                        ...
                        (!content ? (
                            ...
                            >
                                ...
                                <figcaption>
                                    ...
                                    <span>
                                        ...
                                        {preview.preview.sizeBytes.toLocaleString()}{" "}
                                        bytes
                                    </span>
                                    {source.kind === "workingTree" && (
                                        <Button
                            ...
                            >
                                {"sizeBytes" in content && (
                                    <small>
                                        {content.sizeBytes.toLocaleString()}{" "}
                                        bytes
                                    </small>
                                )}
                                {source.kind === "workingTree" &&
