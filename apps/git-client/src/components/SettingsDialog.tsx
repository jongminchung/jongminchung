...
export function SettingsDialog({
    ...
    const setPreference =
        onAppearancePreferenceChange ?? appearance.setPreference;
    const appearanceSelection = preference.syncWithOs
        ? "system"
        : preference.theme;
    ...
    const filteredCommands = useMemo(() => {
        ...
        return COMMAND_MANIFEST.commands.filter(
            (command) =>
                !query ||
                `${command.label} ${command.id} ${command.category}`
                    .toLocaleLowerCase()
                    .includes(query),
        );
    }, [keymapFilter]);
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Icon name="appearance" size={15} /> Appearance &
                            Behavior
                        </TabsTrigger>
                        <TabsTrigger
                            value="keymap"
                    ...
                    <TabsContent render={<main />} value="appearance">
                        ...
                        >
                            ...
                            <RadioList
                                label="Theme"
                                onChange={(value) => {
                                    const selection = APPEARANCE_MODES.find(
                    ...
                    <TabsContent render={<main />} value="versionControl">
                        ...
                        >
                            ...
                            onOpenRepositorySettings ? (
                                <>
                                    <p>
                                        Configure Git remotes, worktrees,
                                        submodules, ignore rules, and
                                ...
                                <p>
                                    These defaults are applied when a project is
                                    opened for the first time. Repository-local
                                    Git settings remain project-specific.
                                </p>
                            )}
                        </div>
                    </TabsContent>
                    <TabsContent render={<main />} value="notifications">
                        ...
                        >
                            ...
                            />
                            <p>
                                Failures remain visible in the status bar and
                                Git Console even when pop-up notifications are
                                hidden.
                            </p>
                        </div>
                    </TabsContent>
