        ...
        >
                        ...
                        <TableCell className="w-[130px] py-1">
                          <Button
                            ...
                            onKeyDown={(event) =>
                              ...
                              captureShortcut(command.id, event)
                            }
                            type="button"
          ...
          <TabsContent render={<main />} value="versionControl">
            <div className="settingsPage">
              ...
              {showRepositorySettings && onOpenRepositorySettings ? (
                <>
                  <p>
                    Configure Git remotes, worktrees, submodules, ignore rules,
                    and repository-local Git config.
                  </p>
                  <Button
                ...
                <p>
                  These defaults are applied when a project is opened for the
                  first time. Repository-local Git settings remain
                  project-specific.
                </p>
              )}
            </div>
          ...
          <TabsContent render={<main />} value="notifications">
            <div className="settingsPage">
              ...
              />
              <p>
                Failures remain visible in the status bar and Git Console even
                when pop-up notifications are hidden.
              </p>
            </div>
          </TabsContent>
        </Tabs>
