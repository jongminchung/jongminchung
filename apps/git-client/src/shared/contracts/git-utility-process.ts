...
export const MainToGitUtilityMessageSchema = z
    ...
    .readonly();
export type MainToGitUtilityMessage = Readonly<
    z.infer<typeof MainToGitUtilityMessageSchema>
>;
...
export type GitUtilityProtocolErrorCode = z.infer<
    typeof GitUtilityProtocolErrorCodeSchema
>;
    ...
    .superRefine((message, context) => {
        if (
            ...
            context.addIssue({
                ...
                path: ["event", "data"],
                message:
                    "Git utility output event exceeds the transport chunk limit",
            });
        }
    })
    .readonly();
export type GitUtilityToMainMessage = Readonly<
    z.infer<typeof GitUtilityToMainMessageSchema>
>;

export type UtilityReadyMessage = Extract<
