...
export const DesktopStreamEnvelopeSchema = z.discriminatedUnion("kind", [
    ...
    z
        .object({
            kind: z.literal("git.query.event"),
    ...
    z
        .object({
            kind: z.literal("git.creation.event"),
    ...
    z
        .object({
            kind: z.literal("repository.changed"),
...
export type DesktopStreamEnvelope = Readonly<
    z.infer<typeof DesktopStreamEnvelopeSchema>
>;
export type DesktopStreamEventKind = Exclude<
    DesktopStreamEnvelope["kind"],
    "ready"
>;
