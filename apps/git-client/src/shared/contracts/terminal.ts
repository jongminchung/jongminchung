...
export const TerminalShellIdSchema = z.enum(["zsh", "bash", "sh", "fish", "ksh", "csh", "tcsh"]);
...
export type TerminalLaunchTarget = Readonly<z.infer<typeof TerminalLaunchTargetSchema>>;
...
export const TerminalShellDescriptorSchema = z
  ...
  .strict()
  .readonly();
export type TerminalShellDescriptor = Readonly<z.infer<typeof TerminalShellDescriptorSchema>>;
...
export const TerminalAgentDescriptorSchema = z
  ...
  .strict()
  .readonly();
export type TerminalAgentDescriptor = Readonly<z.infer<typeof TerminalAgentDescriptorSchema>>;
...
export type TerminalLaunchTargets = Readonly<z.infer<typeof TerminalLaunchTargetsSchema>>;

export const TerminalListLaunchTargetsRequestSchema = z.object({}).strict().readonly();
...
export const TerminalCreateRequestSchema = z
  ...
  .strict()
  .readonly();
export type TerminalCreateRequest = Readonly<z.infer<typeof TerminalCreateRequestSchema>>;
...
export const TerminalCreateResultSchema = z
  ...
  .strict()
  .readonly();
export type TerminalCreateResult = Readonly<z.infer<typeof TerminalCreateResultSchema>>;
...
export const TerminalOutputEventSchema = z
  .object({
    ...
    data: z.array(z.number().int().min(0).max(255)).max(TERMINAL_OUTPUT_CHUNK_BYTES),
  })
  .strict()
  .readonly();
...
export const TerminalEventEnvelopeSchema = z
  ...
  .readonly();
export type TerminalEventEnvelope = Readonly<z.infer<typeof TerminalEventEnvelopeSchema>>;
