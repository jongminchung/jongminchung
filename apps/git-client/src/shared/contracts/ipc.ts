...
export const IPC_CHANNELS = {
    ...
    diagnosticsKeyboardShortcutsPdf:
        "git-client:diagnostics:keyboard-shortcuts-pdf",
    diagnosticsListLeftoverDirectories:
        "git-client:diagnostics:list-leftover-directories",
    diagnosticsDeleteLeftoverDirectories:
        "git-client:diagnostics:delete-leftover-directories",
...
export interface DesktopApi {
    ...
    readonly diagnostics: {
        ...
        listLeftoverDirectories(): Promise<
