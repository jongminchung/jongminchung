...
export type WindowPresentationMode = z.infer<
  typeof WindowPresentationModeSchema
>;
...
export const CommandLineLauncherInfoSchema = z
  ...
  .strict()
  .readonly();
export type CommandLineLauncherInfo = z.infer<
  typeof CommandLineLauncherInfoSchema
>;
...
export type DiagnosticConfigurationKind = z.infer<
  typeof DiagnosticConfigurationKindSchema
>;
...
export const DiagnosticLeftoverDirectorySchema = z
  ...
  .strict()
  .readonly();
export type DiagnosticLeftoverDirectory = z.infer<
  typeof DiagnosticLeftoverDirectorySchema
>;
  ...
  .object({
    ids: z
      ...
      .refine(
        ...
        "Leftover directory IDs must be unique",
      ),
  })
  .strict()
  .readonly();
...
export const HtmlExportRequestSchema = z
  ...
  .refine(
    (value) =>
      value.files.reduce((total, file) => total + file.content.length, 0) <=
      20_971_520,
...
export const PatchTextExportRequestSchema = z
  ...
  .strict()
  .readonly();
export type PatchTextExportRequest = z.infer<
  typeof PatchTextExportRequestSchema
>;
...
export type OfflineInspectionFile = z.infer<
  typeof OfflineInspectionFilesSchema
>[number];
...
export const NativeCommandStatesSchema = z
  .array(NativeCommandStateSchema)
  .max(1_000);
