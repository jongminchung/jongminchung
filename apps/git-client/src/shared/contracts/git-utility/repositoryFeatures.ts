...
export const GitSynchronizedBranchOperationSchema =
    GitOperationSchema.transform(
        (operation, context): GitSynchronizedBranchOperation => {
            if (operation.kind === "checkout" && !operation.force)
                return operation;
...
export const GitLocalHistoryScopeSchema = z.discriminatedUnion("kind", [
    ...
    z
        ...
        .strict(),
    z
        .object({ kind: z.literal("recent"), repositoryId: RepositoryIdSchema })
        .strict(),
]);
export type GitLocalHistoryScope = Readonly<
    z.infer<typeof GitLocalHistoryScopeSchema>
>;
...
export type GitLocalHistoryChange = Readonly<
    z.infer<typeof GitLocalHistoryChangeSchema>
>;
...
export const GitLocalHistoryActivitySchema = z
    ...
    .strict()
    .readonly();
export type GitLocalHistoryActivity = Readonly<
    z.infer<typeof GitLocalHistoryActivitySchema>
>;
