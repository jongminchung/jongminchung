...
export const OpenRepositoryRequestSchema = z
    ...
    .readonly();
export type OpenRepositoryRequest = Readonly<
    z.infer<typeof OpenRepositoryRequestSchema>
>;
...
export const GitCloneRepositoryRequestSchema = z
    ...
    .strict()
    .readonly();
export type GitCloneRepositoryRequest = Readonly<
    z.infer<typeof GitCloneRepositoryRequestSchema>
>;
...
export type RepositorySnapshot = Readonly<
    z.infer<typeof RepositorySnapshotSchema>
>;
...
const GitRelativePathSchema = GitPathSchema.refine(
    hasSafeRelativePath,
...
const GitServiceMessageSchema = z
    ...
    .refine(
        (value) => isWithinUtf8Bytes(value, 1024 * 1024),
...
const GitConflictResultSchema = z
    ...
    .refine(
        ...
        "Conflict result must not contain NUL",
    )
    .refine(
...
export const GitWorkingTreeFileRequestSchema = z
    ...
    .strict()
    .readonly();
export type GitWorkingTreeFileRequest = Readonly<
    z.infer<typeof GitWorkingTreeFileRequestSchema>
>;
...
const GitSynchronizedBranchOperationSchema = GitOperationSchema.transform(
    (operation, context): GitSynchronizedBranchOperation => {
        ...
        if (operation.kind === "createBranch" && operation.checkout)
            return operation;
        context.addIssue({
            code: "custom",
            message:
...
const GitMultiRootRollbackOperationSchema = GitOperationSchema.transform(
    (operation, context): GitMultiRootRollbackOperation => {
        if (operation.kind === "checkout" && !operation.force) return operation;
        if (operation.kind === "deleteBranch" && !operation.force)
            return operation;
        context.addIssue({
            code: "custom",
            message:
                "Rollback operations must be non-forced checkout or delete-branch operations",
        });
        return z.NEVER;
    },
);
export const GitMultiRootOutcomeSchema = z
    .object({
        ...
        message: z
            ...
            .refine(
                (value) => !value.includes("\0"),
                "Outcome message must not contain NUL",
            ),
    })
    .strict()
    .readonly();
export type GitMultiRootOutcome = Readonly<
    z.infer<typeof GitMultiRootOutcomeSchema>
>;
export const GitMultiRootRollbackStepSchema = z
    .object({
        ...
        description: z
            ...
            .refine(
                (value) => !value.includes("\0"),
                "Rollback description must not contain NUL",
            ),
        operations: z
            .array(GitMultiRootRollbackOperationSchema)
            .min(1)
            .max(2)
            .readonly(),
    })
    .strict()
    .readonly();
export type GitMultiRootRollbackStep = Readonly<
    z.infer<typeof GitMultiRootRollbackStepSchema>
>;
export const GitMultiRootResultSchema = z
    ...
    .strict()
    .readonly();
export type GitMultiRootResult = Readonly<
    z.infer<typeof GitMultiRootResultSchema>
>;
...
export const GitPatchExportResultSchema = z
    ...
    .strict()
    .readonly();
export type GitPatchExportResult = Readonly<
    z.infer<typeof GitPatchExportResultSchema>
>;
...
export const GitShelfEntriesSchema = z
    .array(GitShelfEntrySchema)
    .max(10_000)
    .readonly();
...
export const GitChangelistsSchema = z
    .array(GitChangelistSchema)
    .max(10_000)
    .readonly();
export const GitChangelistCommitResultSchema = z
    ...
    .strict()
    .readonly();
export type GitChangelistCommitResult = Readonly<
    z.infer<typeof GitChangelistCommitResultSchema>
>;
...
export const GitRecoveryEntriesSchema = z
    .array(GitRecoveryEntrySchema)
    .max(200)
    .readonly();
export const GitRecoveryRestoreResultSchema = z
    ...
    .strict()
    .readonly();
export type GitRecoveryRestoreResult = Readonly<
    z.infer<typeof GitRecoveryRestoreResultSchema>
>;

export const GitLocalHistoryEntrySchema = z
    .object({
        id: GitUuidSchema,
        repositoryId: RepositoryIdSchema,
        createdAtMs: z.number().int().nonnegative().safe(),
        ...
        snapshotSha256: GitChecksumSchema,
    })
    .strict()
    .readonly();
export type GitLocalHistoryEntry = Readonly<
    z.infer<typeof GitLocalHistoryEntrySchema>
>;
export const GitLocalHistoryEntriesSchema = z
    .array(GitLocalHistoryEntrySchema)
    .max(100)
    .readonly();
...
export const GitConflictFilesSchema = z
    .array(GitConflictFileSchema)
    .max(50_000)
    .readonly();
...
export const GitConflictContentSchema = z
    ...
    .strict()
    .readonly();
export type GitConflictContent = Readonly<
    z.infer<typeof GitConflictContentSchema>
>;
...
export const GitBranchComparisonSchema = z
    ...
    .strict()
    .readonly();
export type GitBranchComparison = Readonly<
    z.infer<typeof GitBranchComparisonSchema>
>;
...
export const GitPreCommitCheckSchema = z
    ...
    .strict()
    .readonly();
export type GitPreCommitCheck = Readonly<
    z.infer<typeof GitPreCommitCheckSchema>
>;
...
export const GitConfigEntriesSchema = z
    .array(GitConfigEntrySchema)
    .max(10_000)
    .readonly();
...
export const GitSubmoduleInfosSchema = z
    .array(GitSubmoduleInfoSchema)
    .max(10_000)
    .readonly();
...
export const GitCommitSignatureSchema = z
    ...
    .strict()
    .readonly();
export type GitCommitSignature = Readonly<
    z.infer<typeof GitCommitSignatureSchema>
>;
...
export const GitRemoteInfosSchema = z
    .array(GitRemoteInfoSchema)
    .max(1_000)
    .readonly();
...
export const GitWorktreeInfosSchema = z
    .array(GitWorktreeInfoSchema)
    .max(1_000)
    .readonly();
...
const GitPreviewSubjectSchema = z
    ...
    .refine(
        (value) => !value.includes("\0"),
        "Subject must not contain a null byte",
    );
...
export const GitHistoryRewritePreviewSchema = z
    ...
    .strict()
    .readonly();
export type GitHistoryRewritePreview = Readonly<
    z.infer<typeof GitHistoryRewritePreviewSchema>
>;
...
export const GitRepositoryServiceRequestSchema = z
    .discriminatedUnion("operation", [
        ...
        z
            .object({
                operation: z.literal("captureLocalHistory"),
                repositoryId: RepositoryIdSchema,
                label: z.string().min(1).max(16_384).nullable(),
            })
            .strict(),
        z
            .object({
                operation: z.literal("listLocalHistory"),
                repositoryId: RepositoryIdSchema,
        ...
        z
            .object({
                operation: z.literal("restoreLocalHistory"),
                repositoryId: RepositoryIdSchema,
                entryId: GitUuidSchema,
                path: GitRelativePathSchema,
            })
        ...
        z
            .object({
                operation: z.literal("labelLocalHistory"),
                repositoryId: RepositoryIdSchema,
                entryId: GitUuidSchema,
...
export const GitRepositoryServiceResultSchema = z
    .discriminatedUnion("operation", [
        ...
        z
            .object({
                operation: z.literal("captureLocalHistory"),
                value: GitLocalHistoryEntrySchema,
            })
            .strict(),
        z
            .object({
                operation: z.literal("listLocalHistory"),
                value: GitLocalHistoryEntriesSchema,
            })
            .strict(),
        z
            .object({
            ...
            .strict(),
        z.object({ operation: z.literal("restoreLocalHistory") }).strict(),
        z
            .object({
                operation: z.literal("labelLocalHistory"),
                value: GitLocalHistoryEntrySchema,
...
export const GitReadFileRequestSchema = z
    ...
    .strict()
    .readonly();
export type GitReadFileRequest = Readonly<
    z.infer<typeof GitReadFileRequestSchema>
>;
...
export const RepositoryChangedEventSchema = z
    ...
    .readonly();
export type RepositoryChangedEvent = Readonly<
    z.infer<typeof RepositoryChangedEventSchema>
>;
...
export const GitWatchRepositoryRequestSchema = z
    ...
    .strict()
    .readonly();
export type GitWatchRepositoryRequest = Readonly<
    z.infer<typeof GitWatchRepositoryRequestSchema>
>;
