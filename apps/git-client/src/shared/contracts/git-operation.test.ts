...
const generatedFitsContract: IsAssignable<GitOperation, ValidatedGitOperation> =
    true;
const contractFitsGenerated: IsAssignable<ValidatedGitOperation, GitOperation> =
    true;
...
describe("GitOperationSchema", () => {
    ...
    it("rejects unknown, non-strict, missing, oversized, and unsafe operation fields", () => {
        const invalid: readonly unknown[] = [
            ...
            {
                kind: "stage",
                paths: Array.from({ length: 10_001 }, () => "file"),
            },
            ...
            {
                kind: "revert",
                revisions: Array.from({ length: 501 }, () => oid),
                noCommit: true,
            },
        ];
    ...
    it("enforces rebase plan bounds, identifiers, and action/message relationships", () => {
        ...
        const invalid: readonly unknown[] = [
            ...
            interactiveRebase([
                { ...entry, mergeCommit: true, action: "edit" },
            ]),
