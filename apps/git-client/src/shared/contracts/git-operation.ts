...
const ObjectOidSchema = z
    ...
    .regex(
        ...
        "Object ID must contain 40 or 64 hex digits",
    );
...
const BoundedTextSchema = z
    ...
    .refine(
        (value) => isWithinUtf8Bytes(value, MAX_TEXT_BYTES),
        "Text must not exceed 5 MiB",
    );
...
const PatchSchema = z
    ...
    .refine(
        (value) => !value.includes("\0"),
        "Patch must not contain a null byte",
    )
    .refine(
...
const PushModeSchema = z.discriminatedUnion("kind", [
    ...
    z
        .object({
            kind: z.literal("forceWithLease"),
            expectedRemoteOid: ObjectOidSchema,
        })
        .strict(),
]);
        ...
        for (const [index, entry] of entries.entries()) {
            ...
            if (
                ...
                context.addIssue({
                    code: "custom",
                    message:
                        "Squash and fixup require an earlier picked commit",
                    path: [index, "action"],
                });
            }
...
export const GitOperationSchema = z.discriminatedUnion("kind", [
    ...
    z
        .object({ kind: z.literal("addIntent"), paths: RequiredPathsSchema })
        .strict(),
    z
        .object({ kind: z.literal("unstage"), paths: RequiredPathsSchema })
        .strict(),
    z
        .object({ kind: z.literal("removeCached"), paths: RequiredPathsSchema })
        .strict(),
    z
        .object({ kind: z.literal("discard"), paths: RequiredPathsSchema })
        .strict(),
    z
        .object({
    ...
    z
        .object({
            ...
            remote: RefComponentSchema.nullable(),
            prune: z.boolean(),
        })
        .strict(),
    ...
    z
        .object({
            ...
            oldName: RefNameSchema,
            newName: RefNameSchema,
        })
        .strict(),
    z
        .object({
    ...
    z
        .object({
            kind: z.literal("setUpstream"),
            branch: RefNameSchema,
            upstream: RevisionSchema,
        })
        .strict(),
    z
        .object({
    ...
    z
        ...
        .strict(),
    z
        .object({ kind: z.literal("dropCommits"), revisions: RevisionsSchema })
        .strict(),
    z
        .object({
            kind: z.literal("squashCommits"),
            revisions: SquashRevisionsSchema,
        })
        .strict(),
    z
        .object({
    ...
    z
        .object({
            kind: z.literal("createFixupCommit"),
            revision: RevisionSchema,
        })
        .strict(),
    z
        .object({
            kind: z.literal("createSquashCommit"),
            revision: RevisionSchema,
        })
        .strict(),
    z
    ...
    z
        .object({
            kind: z.literal("skip"),
            operation: z.enum(["rebase", "cherryPick"]),
        })
        .strict(),
    z
        .object({
    ...
    z
        .object({
            kind: z.literal("updateSubmodules"),
            init: z.boolean(),
            recursive: z.boolean(),
        })
        .strict(),
    ...
    z
        .object({
            kind: z.literal("remoteAdd"),
            name: RefComponentSchema,
            url: UrlSchema,
        })
        .strict(),
    z
        .object({ kind: z.literal("remoteRemove"), name: RefComponentSchema })
        .strict(),
    z
        .object({
            kind: z.literal("remoteSetUrl"),
            name: RefComponentSchema,
            url: UrlSchema,
        })
        .strict(),
