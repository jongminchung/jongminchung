...
export function asPatchExportResult(
...
export function asConflictContent(
  content: ElectronConflictContent,
): ConflictContent {
  return { ...content };
}
...
export function asMultiRootOutcome(
...
export function asMultiRootResult(
  result: ElectronMultiRootResult,
): MultiRootResult {
  return {
