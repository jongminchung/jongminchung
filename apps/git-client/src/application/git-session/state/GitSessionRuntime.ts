...
import { RepositoryWatchSession } from "../use-cases/RepositoryWatchSession";
...
export function createGitSessionRuntime(
    ...
    const runtime: GitSessionRuntime = {
        ...
        forgetRepository: (repositoryId) => {
            ...
            if (runtime.activeRepositoryId === repositoryId)
                runtime.activeRepositoryId = null;
            if (runtime.activeSnapshot?.id === repositoryId)
