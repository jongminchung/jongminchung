...
export interface GitSessionCapabilities {
  ...
  readonly queries: {
    ...
    readonly indexLog: (filters: LogFilters, order: LogOrder) => Promise<void>;
    ...
    readonly createPatchText: (revisions: readonly string[]) => Promise<string>;
    ...
    readonly loadStashFiles: (stash: string) => Promise<readonly FileChange[]>;
    ...
    readonly loadMergedBranches: (target: string) => Promise<readonly string[]>;
  ...
  readonly mutations: {
    ...
    readonly abortOperation: (operation: AbortableOperation) => Promise<void>;
