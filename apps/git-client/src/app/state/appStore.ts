...
const createAppOverlaySlice: AppSliceCreator<AppOverlaySlice> = (set) => ({
    ...
    setLeftoverDirectoriesOpen: (value) =>
        set((state) => ({
            leftoverDirectoriesOpen: resolve(
                value,
                state.leftoverDirectoriesOpen,
            ),
        })),
    setCommandLineLauncherOpen: (value) =>
        set((state) => ({
            commandLineLauncherOpen: resolve(
                value,
                state.commandLineLauncherOpen,
            ),
        })),
    setDiagnosticConfiguration: (value) =>
        set((state) => ({
            diagnosticConfiguration: resolve(
                value,
                state.diagnosticConfiguration,
            ),
        })),
    setNewProjectSettingsOpen: (value) =>
        set((state) => ({
            newProjectSettingsOpen: resolve(
                value,
                state.newProjectSettingsOpen,
            ),
        })),
...
const createAppSettingsSlice: AppSliceCreator<AppSettingsSlice> = (set) => ({
    ...
    setToolWindowLayoutsLoaded: (value) =>
        set((state) => ({
            toolWindowLayoutsLoaded: resolve(
                value,
                state.toolWindowLayoutsLoaded,
            ),
        })),
