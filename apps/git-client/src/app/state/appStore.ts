...
import { DEFAULT_APPEARANCE_PREFERENCE, type AppearancePreference } from "../../domain/appearance";
import { type SavedMacro } from "../../domain/macros";
import { DEFAULT_PRODUCT_SETTINGS, type ProductSettings } from "../../domain/productSettings";
import {
...
export interface AppSettingsSlice {
  ...
  readonly setRunConfigurationTemplates: Setter<readonly RunConfigurationTemplate[]>;
...
const createAppOverlaySlice: AppSliceCreator<AppOverlaySlice> = (set) => ({
  ...
  setShowRepositoryDialog: (value) =>
    set((state) => ({ showRepositoryDialog: resolve(value, state.showRepositoryDialog) })),
  setPendingTrustPath: (value) =>
    set((state) => ({ pendingTrustPath: resolve(value, state.pendingTrustPath) })),
  setRepositoryDialogMode: (value) =>
    set((state) => ({ repositoryDialogMode: resolve(value, state.repositoryDialogMode) })),
  setProjectSwitcherOpen: (value) =>
    set((state) => ({ projectSwitcherOpen: resolve(value, state.projectSwitcherOpen) })),
  setRepositoryTool: (value) =>
    set((state) => ({ repositoryTool: resolve(value, state.repositoryTool) })),
  setPushRequest: (value) => set((state) => ({ pushRequest: resolve(value, state.pushRequest) })),
  setSettingsOpen: (value) =>
    set((state) => ({ settingsOpen: resolve(value, state.settingsOpen) })),
  setHelpOpen: (value) => set((state) => ({ helpOpen: resolve(value, state.helpOpen) })),
  setWhatsNewOpen: (value) =>
    set((state) => ({ whatsNewOpen: resolve(value, state.whatsNewOpen) })),
  setActivityMonitorOpen: (value) =>
    set((state) => ({ activityMonitorOpen: resolve(value, state.activityMonitorOpen) })),
  setSpecialFilesOpen: (value) =>
    set((state) => ({ specialFilesOpen: resolve(value, state.specialFilesOpen) })),
  setLeftoverDirectoriesOpen: (value) =>
    set((state) => ({ leftoverDirectoriesOpen: resolve(value, state.leftoverDirectoriesOpen) })),
  setCommandLineLauncherOpen: (value) =>
    set((state) => ({ commandLineLauncherOpen: resolve(value, state.commandLineLauncherOpen) })),
  setDiagnosticConfiguration: (value) =>
    set((state) => ({ diagnosticConfiguration: resolve(value, state.diagnosticConfiguration) })),
  setNewProjectSettingsOpen: (value) =>
    set((state) => ({ newProjectSettingsOpen: resolve(value, state.newProjectSettingsOpen) })),
  setQuickSwitchSchemeOpen: (value) =>
    set((state) => ({ quickSwitchSchemeOpen: resolve(value, state.quickSwitchSchemeOpen) })),
  setRepairIdeOpen: (value) =>
    set((state) => ({ repairIdeOpen: resolve(value, state.repairIdeOpen) })),
  setInvalidateCachesOpen: (value) =>
    set((state) => ({ invalidateCachesOpen: resolve(value, state.invalidateCachesOpen) })),
  setRunConfigurationTemplatesOpen: (value) =>
    set((state) => ({
      runConfigurationTemplatesOpen: resolve(value, state.runConfigurationTemplatesOpen),
    })),
  setSavedMacrosOpen: (value) =>
    set((state) => ({ savedMacrosOpen: resolve(value, state.savedMacrosOpen) })),
  setLayoutChooserMode: (value) =>
    set((state) => ({ layoutChooserMode: resolve(value, state.layoutChooserMode) })),
});
...
const createAppSettingsSlice: AppSliceCreator<AppSettingsSlice> = (set) => ({
  ...
  setSavedMacros: (value) => set((state) => ({ savedMacros: resolve(value, state.savedMacros) })),
  setSavedMacrosLoaded: (value) =>
    set((state) => ({ savedMacrosLoaded: resolve(value, state.savedMacrosLoaded) })),
  setMacroRecording: (value) =>
    set((state) => ({ macroRecording: resolve(value, state.macroRecording) })),
  setRecordedCommandIds: (value) =>
    set((state) => ({ recordedCommandIds: resolve(value, state.recordedCommandIds) })),
  setLastMacro: (value) => set((state) => ({ lastMacro: resolve(value, state.lastMacro) })),
  setProductSettings: (value) =>
    set((state) => ({ productSettings: resolve(value, state.productSettings) })),
  setToolWindowLayouts: (value) =>
    set((state) => ({ toolWindowLayouts: resolve(value, state.toolWindowLayouts) })),
  setToolWindowLayoutsLoaded: (value) =>
    set((state) => ({ toolWindowLayoutsLoaded: resolve(value, state.toolWindowLayoutsLoaded) })),
  setNewProjectSettings: (value) =>
    set((state) => ({ newProjectSettings: resolve(value, state.newProjectSettings) })),
  setNewProjectAppearancePreference: (value) =>
    set((state) => ({
      newProjectAppearancePreference: resolve(value, state.newProjectAppearancePreference),
    })),
  setRunConfigurationTemplates: (value) =>
    set((state) => ({
      runConfigurationTemplates: resolve(value, state.runConfigurationTemplates),
    })),
  setProductSettingsLoaded: (value) =>
    set((state) => ({ productSettingsLoaded: resolve(value, state.productSettingsLoaded) })),
  setProjectDefaultsLoaded: (value) =>
    set((state) => ({ projectDefaultsLoaded: resolve(value, state.projectDefaultsLoaded) })),
  setDirtyEditorCount: (value) =>
    set((state) => ({ dirtyEditorCount: resolve(value, state.dirtyEditorCount) })),
  setRepositoryChromeMode: (value) =>
    set((state) => ({ repositoryChromeMode: resolve(value, state.repositoryChromeMode) })),
});
