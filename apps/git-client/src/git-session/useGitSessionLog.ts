...
import { isGitRequestCancelled, sanitizeGitError } from "../domain/gitActivity";
import { parseLog } from "../domain/parsers";
import type { Commit } from "../domain/types";
import type { LogFilters, LogOrder, RepositorySnapshot } from "../shared/contracts/model";
import {
  cancelRequests,
  createLogRequest,
  updateRepositorySession,
} from "./gitSessionControllerHelpers";
import type { GitSessionRuntime, LogSelection } from "./gitSessionRuntime";
import type { GitSessionRefreshCoordinator, GitSessionStore } from "./gitSessionStore";
import type { RepositorySession } from "./sessionTypes";

type RequestRuntime = ReturnType<typeof import("./useGitRequestRuntime").useGitRequestRuntime>;
