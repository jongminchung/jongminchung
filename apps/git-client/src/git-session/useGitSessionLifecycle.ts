...
import type { CloneOptions, RequestId, RepositorySnapshot } from "../shared/contracts/model";
import { loadingSession } from "./gitSessionControllerHelpers";
...
import type { WorkspaceState, WorkspaceTab } from "./sessionTypes";
...
interface GitSessionLifecycleOptions {
  ...
  readonly welcomeRecentFixture: boolean;
}
...
export function useGitSessionLifecycle({
  ...
  useEffect(() => {
    ...
    runInBackground(persist(), "Workspace persistence");
  }, [
    activeRepositoryPath,
    fixture,
    openRepositoryPathsJson,
