...
import { checkedInEvidenceRoot, validateEvidenceBundle } from "./validate-evidence.mjs";
...
void describe("Rebased 1.1.11 independent evidence manifest", () => {
  ...
  void it("fails closed for incorrect application metadata", async () => {
    ...
    await assert.rejects(validateEvidenceBundle(root), /identify Rebased 1\.1\.11/u);
  });
