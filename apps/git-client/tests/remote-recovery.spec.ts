...
test("keeps Push keyboard-safe through exact lease confirmation and Escape", async ({
    page,
}) => {
...
test("focuses the first history rewrite action and dismisses with Escape", async ({
    page,
}) => {
    await page
        .getByRole("row", {
