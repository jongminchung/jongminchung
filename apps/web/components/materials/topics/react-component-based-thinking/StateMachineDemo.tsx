    ...
    return (
        <g>
            <motion.rect
                ...
                animate={{
                    strokeDashoffset: dashed && !reducedMotion ? -16 : 0,
                }}
                transition={{
                    duration: 0.8,
                    ease: "linear",
                    repeat: dashed ? Infinity : 0,
                }}
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    style={{
                        flex: isNarrow ? undefined : "0 1 300px",
            ...
            >
                버튼의 한살이가 자동으로 반복된다 — 왼쪽 UI와 오른쪽 상태
                그래프는 같은 상태 머신의 두 표현이다
            </div>
        </div>
    );
};
