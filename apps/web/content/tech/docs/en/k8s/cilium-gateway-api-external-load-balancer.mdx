...
area: k8s
documentKind: how-to
title: "Use an External Load Balancer with Cilium Gateway API"
...
- **Pattern C binds listeners directly with `hostNetwork`**
  ...
  - [Per-node cloud public IPs](/en/docs/k8s/cilium-gateway-api-direct-public-ip) contains the full host-network configuration
