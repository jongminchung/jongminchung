...
seriesOrder: 1
title: "Distributed Failure Handling Part 1: How Far Did the Request Get?"
...
sourceUrl: https://github.com/jongminchung/jongminchung/blob/main/apps/web/content/tech/docs/en/architecture/failure-safe-distributed-transactions.mdx
---
...
- **The next article explains [why Saga, state machines, and orchestrators are difficult to maintain](/en/docs/architecture/saga-state-machine-orchestrator-costs)**
- **The final article compares [how OpenStack and Kubernetes converge after failures](/en/docs/architecture/reconciliation-in-openstack-and-kubernetes) with application design**
