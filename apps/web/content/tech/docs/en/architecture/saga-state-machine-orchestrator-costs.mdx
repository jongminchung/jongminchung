...
seriesOrder: 2
title: "Distributed Failure Handling Part 2: The Hidden Cost of Saga and Orchestration"
...
sourceUrl: https://github.com/jongminchung/jongminchung/blob/main/apps/web/content/tech/docs/en/architecture/saga-state-machine-orchestrator-costs.mdx
---
...
- **The next article analyzes [how OpenStack and Kubernetes converge complex distributed state with reconciliation loops](/en/docs/architecture/reconciliation-in-openstack-and-kubernetes)**
