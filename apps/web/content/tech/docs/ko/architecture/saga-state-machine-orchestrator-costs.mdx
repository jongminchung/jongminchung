...
seriesOrder: 2
title: "분산 장애 처리 2편: Saga와 오케스트레이터의 숨은 비용"
...
sourceUrl: https://github.com/jongminchung/jongminchung/blob/main/apps/web/content/tech/docs/ko/architecture/saga-state-machine-orchestrator-costs.mdx
---
...
- **다음 글에서는 [OpenStack와 Kubernetes가 복잡한 분산 상태를 조정 루프로 수렴시키는 방식](/ko/docs/architecture/reconciliation-in-openstack-and-kubernetes)을 분석**함
