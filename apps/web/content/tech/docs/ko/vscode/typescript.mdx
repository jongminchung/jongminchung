---
documentKind: "how-to"
title: "TypeScript 언어 서비스와 디버깅"
description: "프로젝트 compiler·언어 서비스·source map·테스트 실행기를 구분하고 작은 Node 프로젝트를 디버깅합니다."
...
이 저장소는 [TypeScript 7 호환성 보고서](/ko/docs/fe/typescript-7-compatibility)가
...
| 프로젝트             | 추가할 확장                                        | 유지할 경계                                                               |
| -------------------- | -------------------------------------------------- | ------------------------------------------------------------------------- |
| Prettier·ESLint      | `esbenp.prettier-vscode`, `dbaeumer.vscode-eslint` | [포맷 충돌 해결](/ko/docs/vscode/format-lint-contract)의 스타일 규칙 분리 |
...
이 저장소에서는 [Web 가이드](https://github.com/jongminchung/jongminchung/blob/main/docs/web/README.md)의 명령을 사용한다.
...
이 저장소의 Next main·standalone은 Bun이라는 점은 [런타임 안내](https://github.com/jongminchung/jongminchung/blob/main/docs/web/bun-standalone-runtime.md)를 따른다.
