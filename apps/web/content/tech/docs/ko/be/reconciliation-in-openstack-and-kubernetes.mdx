...
title: "OpenStack와 Kubernetes로 실패 후 상태 수렴시키기"
...
sourceUrl: https://github.com/jongminchung/jongminchung/blob/main/apps/web/content/tech/docs/ko/be/reconciliation-in-openstack-and-kubernetes.mdx
---
