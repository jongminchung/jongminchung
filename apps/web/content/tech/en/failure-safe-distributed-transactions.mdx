...
sourceUrl: https://github.com/jongminchung/jongminchung/blob/main/apps/web/content/tech/en/failure-safe-distributed-transactions.mdx
---
...
- **The next article explains [why Saga, state machines, and orchestrators are difficult to maintain](/en/saga-state-machine-orchestrator-costs)**
- **The final article compares [how OpenStack and Kubernetes converge after failures](/en/reconciliation-in-openstack-and-kubernetes) with application design**
