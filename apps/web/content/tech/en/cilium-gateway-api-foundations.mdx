...
sourceUrl: https://github.com/jongminchung/jongminchung/blob/main/apps/web/content/tech/en/cilium-gateway-api-foundations.mdx
---
...
- **The remaining articles keep this Gateway contract and change only the entry-point topology**
  - [External load balancer](/en/cilium-gateway-api-external-load-balancer)
  - [Highly available control plane](/en/cilium-gateway-api-multi-control-plane)
  - [Per-node cloud public IPs without an LB](/en/cilium-gateway-api-direct-public-ip)
