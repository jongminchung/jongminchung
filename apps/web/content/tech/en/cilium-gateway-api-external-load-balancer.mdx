...
sourceUrl: https://github.com/jongminchung/jongminchung/blob/main/apps/web/content/tech/en/cilium-gateway-api-external-load-balancer.mdx
---
...
- **Pattern C binds listeners directly with `hostNetwork`**
  ...
  - [Part 4](/en/cilium-gateway-api-direct-public-ip) contains the full host-network configuration
