---
id: the-expensive-main-thread
locale: en
title: "The Browser's Main Thread Is Expensive"
description: "Perceived web performance improves more by deciding which work runs on the main thread and when than by making code locally faster."
thesis: "The core of interactive web performance is scheduling main-thread work by splitting, moving, or deleting it, not merely accelerating computation."
counterargument: "Modern browsers and frameworks are sufficient for most pages, making main-thread design a micro-optimization limited to unusually demanding apps."
