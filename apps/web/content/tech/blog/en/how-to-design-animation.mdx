---
id: how-to-design-animation
locale: en
title: "How to Design an Animation"
description: "Complex animation becomes predictable when modeled as relationships between state and time rather than tuned as CSS properties."
thesis: "Animation quality depends more on modeling the relationship between state changes and time than on the tool or easing function."
counterargument: "Product animation is an iterative craft, and mathematical modeling can constrain creativity while increasing implementation cost."
