...
<InvestmentSection title="The lecture reframes performance as survival">
...
<InvestmentSection title="Second-level thinking is not opposition for its own sake">
...
<InvestmentSection title="A cycle is observed as an environment, not a date">
...
<InvestmentSection title="The strongest idea separates risk from observed volatility">
...
<InvestmentSection title="The missing piece is how to estimate value in practice">
