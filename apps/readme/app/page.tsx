            ...
            <main id="main-content">
                ...
                >
                    <div className={styles.heroCopy}>
                        ...
                        <p className={styles.heroLead}>
                            I turn shared language into clear boundaries, public
                            APIs, and software that can prove what changed.
                        </p>
                ...
                >
                    <div className={styles.sectionHeading}>
                        ...
                        <p>
                            Products, packages, and documents share one rule:
                            the public contract should tell the truth.
                        </p>
                    </div>
                ...
                >
                    <div className={styles.principlesIntro}>
                        ...
                        <p>
                            The first material is language: the decisions,
                            constraints, and failure modes that a team needs to
                            name together.
                        </p>
                    </div>
